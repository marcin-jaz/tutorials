...
<%
	...
	if (storeDescription != null) {
		Integer addressId = storeDescription.getLocationAddressIdInEJBType();
...
var addressData = parent.get(parent.LOCATION_DATA_ID);
...
function createStateWithOptions(paramPrefix, currentCountryCode, currentState)
{
	...
	******************************************************************************/
	...
	function savePanelData()
	{
		...
		parent.put(parent.LOCATION_DATA_ID, addressData);
	}
</script>

</head>
<body class="content" onload="">
<h1><%= (String)storeProfileRB.getProperty("LocationPanel") %></h1>
...
<table>
    <tr>
        ...
        <td colspan="2"><label for="address1_defr"><%= addressTitle %></label></td>
    </tr>
    <tr>
        <td colspan="2"><input style="width: 100%" type='text' id="address1_defr" name="address1" maxlength="50" title='<%= addressTitle + " 1" %>'></td>
    </tr>
    <tr>
        <td colspan="2"><label for="address2_defr"></label><input style="width: 100%" type='text' id="address2_defr" name="address2" maxlength="50" title='<%= addressTitle + " 2" %>'></td>
    </tr>
    <tr>
        <td><label for="zipcode_defr"><%= (String)storeProfileRB.getProperty("Address.zip/postalcode") %></label></td>
        <td colspan="2"><label for="city_defr"><%= (String)storeProfileRB.getProperty("Address.city") %></label></td>
    </tr>
    <tr>
        <td><input style="width: 200px" type='text' id="zipcode_defr" name="zipcode" maxlength="40"></td>
        <td><input style="width: 200px" type='text' id="city_defr" name="city" maxlength="128"></td>
    </tr>
    <tr>
        <td><label for="state_defr"><%= (String)storeProfileRB.getProperty("Address.state/province") %></label></td>
        <td><label for="country_defr"><%= (String)storeProfileRB.getProperty("Address.country") %></label></td>
    </tr>
    <tr>
        <td>
        	<div id="stateDiv">
...
<table>
	...
	document.writeln('</select>');
        ...
        <td><input style="width: 200px" type='text' id="zipcode_db" name="zipcode" maxlength="40"></td>
    </tr>
    <tr>
	...
	if (addressData.country == "") {
        ...
        <td><input style="width: 200px" type='text' id="city_db" name="city" maxlength="128"></td>
    </tr>
    <tr>
        <% String addressTitle = (String)storeProfileRB.get("Address.address"); %>
    ...
    <tr>
        <td colspan="2"><input style="width: 100%" type='text' id="address1_db" name="address1" maxlength="50" title='<%= addressTitle + " 1" %>'></td>
    </tr>
    <tr>
        <td colspan="2"><label for="address2_db"></label><input style="width: 100%" type='text' id="address2_db" name="address2" maxlength="50" title='<%= addressTitle + " 2" %>'></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td colspan="2"><input style="width: 100%" type="text" id="address1" name="address1" maxlength="50" title='<%= addressTitle + " 1" %>'></td>
    </tr>
    <tr>
        <td colspan="2"><label for="address2"></label><input style="width: 100%" type="text" id="address2" name="address2" maxlength="50" title='<%= addressTitle + " 2"%>'></td>
    </tr>
    <tr>
        <td><label for="city"><%= (String)storeProfileRB.getProperty("Address.city") %></label></td>
        <td><label for="state"><%= (String)storeProfileRB.getProperty("Address.state/province") %></label></td>
    </tr>
    <tr>
        <td><input style="width: 200px" type="text" id="city" name="city" maxlength="128"></td>
        <td>
        	<div id="stateDiv">
	<script>
	if (addressData.country == "") {
	...
	document.writeln('</select>');
        ...
        <td><input style="width: 200px" type="text" id="zipcode" name="zipcode" maxlength="40"></td>
    </tr>
</table>
<%
	}
