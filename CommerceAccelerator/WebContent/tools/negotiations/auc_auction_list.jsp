...
//* Defect:13512
//* 
//* Modified  selectDeselectAll("auctionForm")  to mySelectDeselectAll("auctionForm") 
//* Modified the javascript Function myRefreshButtons()
//* Added the java method mySelectDeselectAll() 
...
int rowselect = 1;  
  ...
  for (int i = startIndex; i < endIndex ; i++) {
     ...
     quantity = ab.getQuantityInEJBType();
