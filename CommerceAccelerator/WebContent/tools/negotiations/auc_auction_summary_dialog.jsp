...
<%
  ...
  String  austdate= df.format(auction.getStartTimeInEJBType());
  String  austtime = auction.getAuctStartTime();

  String  auenddat = "";
  String  auendtim = ""; 

  if (auction.getEndTimeInEJBType() != null ) {
    auenddat= df.format(auction.getEndTimeInEJBType());
...
//get the actual end time
  ...
  if (auction.getRealEndTimeInEJBType() != null ) {
	acenddat= df.format(auction.getRealEndTimeInEJBType());
