...
if (customerId != null) {
		property.put(com.ibm.commerce.ejb.helpers.ECConstants.EC_FOR_USER_ID, customerId);
}
...
<html>
  <head>
	...
	function addProductList()
	{
		...
		URLParam.XMLFile		= "order.orderAddProductListDialogB2C";
      ...
      <table>
        <tr>
          <td valign="bottom" align="left">
            <label for="productSKU"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchSKU")) %></label>
          </td>
          <td valign="bottom" align="left">
            <input id="productSKU" type="text" maxlength="64" name="searchSKUNumber" />
          </td>
          <td valign="bottom" align="left">
	    <label for="productSKUSearchType">
            <select id="productSKUSearchType" name="skuSearchType">
      ...
      <table>
        <tr>
          ...
          <input type="checkbox" name="item" value="true" checked="checked"
                 id="searchItems" onclick="toggleCheckBox(this.name);"/>
                 <label for="searchItems"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchItem")) %></label>
          <input type="checkbox" name="product" value="true" checked="checked"
                 id="searchProducts" onclick="toggleCheckBox(this.name);"/>
                 <label for="searchProducts"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchProduct")) %></label>
          </td>
        </tr>
	<tr>		
		<td valign="bottom" align="left" colspan="2">
		<input type="checkbox" name="package" value="true" checked="checked"
			   id="searchPackages" onclick="toggleCheckBox(this.name);"/>
			   <label for="searchPackages"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchPackage")) %></label>
		<input type="checkbox" name="bundle" value="true" checked="checked"
			   id="searchBundles" onclick="toggleCheckBox(this.name);"/>
			   <label for="searchBundles"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchBundle")) %></label>
         </td>
	</tr>
        <tr>
          <td valign="bottom" align="left">
            <label for="byName"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchByName")) %></label>
          </td>
          <td valign="bottom" align="left">
            <input id="byName" type="text" maxlength="64" name="searchProductName" />
          </td>
          <td valign="bottom" align="left">
            <label for="byNameType">
            <select id="byNameType" name="nameSearchType">
		<option value="1" selected ="selected"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType1")) %></option>
		<option value="2"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType2")) %></option>
		<option value="3"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType3")) %></option>
		<option value="4"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType4")) %></option>
        ...
        <tr>
          <td valign="bottom" align="left">
            <label for="byDescr"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchByDescription")) %></label>
          </td>
          <td valign="bottom" align="left">
            <input id="byDescr" type="text" maxlength="64" name="searchProductDesc" />
          </td>
          <td valign="bottom" align="left">
            <label for="byDescrSearchType">
            <select id="byDescrSearchType" name="descSearchType">
		<option value="1" selected ="selected"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType1")) %></option>
		<option value="2"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType2")) %></option>
		<option value="3"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType3")) %></option>
		<option value="4"><%= UIUtil.toHTML((String)orderAddProducts.get("addProductPageSearchType4")) %></option>
