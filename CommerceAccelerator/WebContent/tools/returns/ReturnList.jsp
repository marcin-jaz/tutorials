...
<%
	for (int i=startIndex; i<endIndex; i++)
	{
		...
		{
			FormattedMonetaryAmountDataBean formattedAmount =  new FormattedMonetaryAmountDataBean(	new MonetaryAmount( rma.getTotalCreditInEJBType(), currency ), (StoreAccessBean) store, cmdContext.getLanguageId() );
