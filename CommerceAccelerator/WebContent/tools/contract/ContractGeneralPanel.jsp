...
import="com.ibm.commerce.tools.util.UIUtil,
   ...
   com.ibm.commerce.common.objects.StoreRelationshipJDBCHelperAccessBean,
...
%>
   ...
   try{
   StoreRelationshipJDBCHelperAccessBean srjhab = new StoreRelationshipJDBCHelperAccessBean();
   Integer[] relatedStores = srjhab.findRelatedStores(fStoreId, com.ibm.commerce.server.ECConstants.EC_STRELTYP_CONTRACT);
