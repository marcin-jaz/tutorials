...
<%
	...
	Integer defaultLanguageId = cmdContext.getStore().getLanguageIdInEJBType();
...
<%
				...
				Enumeration eValues = abValue.findByAttributeIdAndLanguageIdAndCatEntryId(arabAttributes.getAttributeReferenceNumberInEJBType(), arabAttributes.getLanguage_idInEJBType(), new Long(catentryID));
