...
function populateFromSearchResults(tc)
{
	...
	<% 
		Long nStoreMemberId=cmdContext.getStore().getMemberIdInEJBType();
	   ...
	   { 
				...
				Long   nCatentryMemberId=dbCatentry.getMemberIdInEJBType();
				...
				Vector vCatenRel=getCatentryRelationAccessBean(dbCatentry.getCatalogEntryReferenceNumberInEJBType());
			%>  
