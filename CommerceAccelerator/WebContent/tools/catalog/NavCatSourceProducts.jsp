...
<%@ page import="com.ibm.commerce.ejb.helpers.ECConstants" %>
...
private String generateEntitlementSQL(CommandContext cmdContext)
{
	...
	try{
		...
		Long lMemberId=cmdContext.getUser().getMemberIdInEJBType();
...
<%
	...
	for (int i=iStartOffset; i<iEndOffset; i++)
	{
		...
		if(enStoreCent.hasMoreElements())
		{
			...
			nCatentryStoreId=abStoreCent.getStoreEntryIDInEJBType();
		}
