...
if (actualLength > 0) {
  	for ( int i=0; i<actualLength; i++) {
		...
		Date dt= aRfq.getCreateTimeInEJBType();
		if (dt!=null) {
		...
		if ("".equals(aRfq.getActivateTime()) || aRfq.getActivateTime() == null){
        	...
        	rfq_startTime = df_d.format(aRfq.getActivateTimeInEJBType()) + " " + df_t.format(aRfq.getActivateTimeInEJBType());
        } 
		...
		if ("".equals(aRfq.getEndTime()) || aRfq.getEndTime() == null){
        	...
        	rfq_endDate = df_d.format(aRfq.getEndTimeInEJBType()) + " " + df_t.format(aRfq.getEndTimeInEJBType());
        }         
        ...
        if (aRfq.getCloseTime() == null || "".equals(aRfq.getCloseTime())){
			...
			rfq_closeTime = df_d.format(aRfq.getCloseTimeInEJBType()) + " " + df_t.format(aRfq.getCloseTimeInEJBType());
        }
%>
