...
<%
	...
	int numOfPPDK = 0;
		...
		abCatentryDes1 = new CatalogEntryDescriptionAccessBean();
	  	...
	  	abCatentryDes1.refreshCopyHelper();
		...
		resProdCurrency = abResponseProd.getCurrency();
	        price_ejb=abResponseProd.getPriceInEJBType();
		quantity_ejb = abResponseProd.getQuantityInEJBType();
		priceAdjustment_ejb=abResponseProd.getPriceAdjustmentInEJBType();		
            }
		...
		if (resProdType.equals(com.ibm.commerce.rfq.utils.RFQConstants.EC_OFFERING_DYNAMICKITBEAN)) 
		{
	  	...
	  	abCatentryDes2.refreshCopyHelper();
