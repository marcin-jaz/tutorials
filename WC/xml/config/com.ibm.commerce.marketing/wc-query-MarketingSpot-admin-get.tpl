...
<!-- marketing content is used in a default content.		                  -->
...
<!-- ======================================================================== -->
BEGIN_XPATH_TO_SQL_STATEMENT
	<!-- fetch the Marketing Spot default content in DMEMSPOTDEF tables -->
...
BEGIN_ASSOCIATION_SQL_STATEMENT
	<!-- return Marketing Spot with ordering in EMSPOT and DMEMSPOTCMD -->
