...
<!-- ATTRDICTGRPATTRREL table -->
	COLS:ATTRDICTGRPATTRREL=ATTRDICTGRPATTRREL:*
	COLS:ATTRDICTGRPATTRREL:ATTRDICTGRP_ID=ATTRDICTGRPATTRREL:ATTRDICTGRP_ID
	COLS:ATTRDICTGRPATTRREL:ATTR_ID=ATTRDICTGRPATTRREL:ATTR_ID
	COLS:ATTRDICTGRPATTRREL:OPTCOUNTER=ATTRDICTGRPATTRREL:OPTCOUNTER	
...
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=
	    ...
	    WHERE
				...
				AND NOT EXISTS ( 
								SELECT
										ATTRDICTGRPATTRREL.$COLS:ATTR_ID$										
								FROM
										ATTRDICTGRPATTRREL
								WHERE
										ATTR.$COLS:ATTR_ID$ = ATTRDICTGRPATTRREL.$COLS:ATTRDICTGRPATTRREL:ATTR_ID$
								)
