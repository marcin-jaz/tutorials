...
<HEAD>
<TITLE><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_STATUS" /></TITLE>
</HEAD>
<BODY>

<H1><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_STATUS" /></H1>
<fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_STATUS_CURRENT" />
<H4><PRE><%= launcher.getStatusReport() %></PRE></H4>
<fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_STATUS_PRIOR" />
<PRE><%= launcher.getExitReport() %></PRE>
