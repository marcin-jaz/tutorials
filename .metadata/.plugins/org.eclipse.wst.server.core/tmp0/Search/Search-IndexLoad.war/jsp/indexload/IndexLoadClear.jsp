...
launcher.clear(configTemplate, configEnvironment, logPath, request.getParameterMap());
%>
...
<HEAD><TITLE><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_CLEARED" /></TITLE></HEAD>
<BODY>

<H1><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_CLEARED" /></H1>
