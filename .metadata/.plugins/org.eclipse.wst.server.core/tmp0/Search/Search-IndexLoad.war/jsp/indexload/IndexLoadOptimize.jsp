...
launcher.optimize(configTemplate, configEnvironment, logPath, request.getParameterMap());
%>
...
<HEAD><TITLE><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_OPTIMIZED" /></TITLE></HEAD>
<BODY>

<H1><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_OPTIMIZED" /></H1>
