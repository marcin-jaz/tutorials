...
launcher.execute(configTemplate, configEnvironment, logPath, request.getParameterMap());
%>
...
<HEAD>
<TITLE><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_PROCESSING" /></TITLE>
<META http-equiv="refresh" content="1; url=/search/indexload/status?profile=${param.profile}&detail=${param.detail}" />
</HEAD>
<BODY>

<H1><fmt:message bundle="${resourceBundle}" key="_MSG_INDEX_PROCESSING" /></H1>
