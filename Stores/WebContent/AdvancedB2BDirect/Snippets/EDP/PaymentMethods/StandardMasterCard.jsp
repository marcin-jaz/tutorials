...
<%-- 
  ...
  *	      - The protocol data fields for the payment method MasterCard
  ...
  *				<c:import url="${snippetJspStoreDir}Snippets/EDP/PaymentMethods/StandardMasterCard.jsp" >
...
<!-- Start - JSP File Name: StandardMasterCard.jsp -->
...
<%-- Get other parameters: showPONumber, hideAmounts --%>
...
<table cellpadding="3" cellspacing="0" border="0" id="StandardMaster_Table_1_<c:out value='${paramNumStatus}' />">
	<tr>
		<td valign="middle" id="StandardMaster_TableCell_1_<c:out value='${paramNumStatus}' />">
			<label for="StandardMaster_InputText_1_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_MAST_CARD_NUMBER" bundle="${edpText}"  /></label>
			
		</td>
		<td valign="middle" id="StandardMaster_TableCell_2_<c:out value='${paramNumStatus}' />">
			<label for="edp_Master_cardExpiryMonth_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_MAST_EXPIRATION_MONTH" bundle="${edpText}"  /></label>
		</td>
		<td valign="middle" id="StandardMaster_TableCell_3_<c:out value='${paramNumStatus}' />">
			<label for="edp_Master_cardExpiryYear_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_MAST_EXPIRATION_YEAR" bundle="${edpText}"  /></label>
		</td>
	</tr>
	<tr>
		<td valign="middle" id="StandardMaster_TableCell_4_<c:out value='${paramNumStatus}' />">
			<input class="input" type="text" name="<c:out value="${inputPrefix}"/>account" value ="<c:out value="${account}" />" id="StandardMaster_InputText_1_<c:out value='${paramNumStatus}' />" 
			...
			<c:if test="${showPONumber}">
				<input type="hidden" name = "purchaseorder_id" value ="<c:out value="${edp_ProtocolData.purchaseorder_id}" />" id="StandardAmex_InputText_2_<c:out value='${paramNumStatus}' />" />
		    	</c:if>
		</td>
		<td valign="middle" id="StandardMaster_TableCell_5_<c:out value='${paramNumStatus}' />" >
			<select name="<c:out value="${inputPrefix}"/>expire_month" class="select c_select_yr_mnth" id="edp_Master_cardExpiryMonth_<c:out value='${paramNumStatus}' />" onchange="javascript:<c:out value='${edp_PI_Form}' />_changed('<c:out value='${inputPrefix}'/>expire_month')" >
					<option <c:if test="${expire_month == 1 }" > selected="selected" </c:if> value="01">01</option>
					<option <c:if test="${expire_month == 2 }" > selected="selected" </c:if> value="02">02</option>
					<option <c:if test="${expire_month == 3 }" > selected="selected" </c:if> value="03">03</option>
					<option <c:if test="${expire_month == 4 }" > selected="selected" </c:if> value="04">04</option>
					<option <c:if test="${expire_month == 5 }" > selected="selected" </c:if> value="05">05</option>
					<option <c:if test="${expire_month == 6 }" > selected="selected" </c:if> value="06">06</option>
					<option <c:if test="${expire_month == 7 }" > selected="selected" </c:if> value="07">07</option>
					<option <c:if test="${expire_month == 8 }" > selected="selected" </c:if> value="08">08</option>
					<option <c:if test="${expire_month == 9 }" > selected="selected" </c:if> value="09">09</option>
		...
		<td valign="middle" id="StandardMaster_TableCell_6_<c:out value='${paramNumStatus}' />" >
		<select name="<c:out value="${inputPrefix}"/>expire_year" class="select c_select_yr_mnth" id="edp_Master_cardExpiryYear_<c:out value='${paramNumStatus}' />" onchange="javascript:<c:out value='${edp_PI_Form}' />_changed('<c:out value='${inputPrefix}'/>expire_year')">
	...
	<tr>
		...
		***************************
		--%>
		<td id="StandardMaster_TableCell_7_<c:out value='${paramNumStatus}' />">
			<label for="StandardMaster_OrderRemainingAmount_<c:out value='${paramNumStatus}' />"><fmt:message key="EDPPaymentMethods_PAYMENT_AMT_REMAINING" bundle="${edpText}"/></label>
		</td>
	</tr>
	<tr>
		<td id="StandardMaster_TableCell_8_<c:out value='${paramNumStatus}' />">
			<input <c:if test="${remainingAmt lt 0.0}"> class="error" </c:if>
				class="input" type="text" name="remainingAmount" id="StandardMaster_OrderRemainingAmount_<c:out value='${paramNumStatus}' />" readonly="readonly" value="<c:out value="${remainingAmt}"/>" />
		</td>
	</tr>
	</c:if>
	<tr>
		<td colspan="3" valign="middle" id="StandardMaster_TableCell_9_<c:out value='${paramNumStatus}' />">
			<label for="StandardMaster_InputText_3_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_PAYMENT_AMOUNT" bundle="${edpText}"/></label>
		</td>
	</tr>
	<tr>
		<td colspan="3" valign="middle" id="StandardMaster_TableCell_10_<c:out value='${paramNumStatus}' />">
			<input class="input" type="text" name="<c:out value='${inputPrefix}'/>piAmount" value="<c:out value="${edp_PayMethodAmount}" />"	id="StandardMaster_InputText_3_<c:out value='${paramNumStatus}' />"  onchange="javascript:<c:out value='${edp_PI_Form}'/>_amount_changed('<c:out value='${inputPrefix}'/>piAmount') "/>
		</td>
	</tr>
	</c:if>
	...
	<tr>
		<td colspan="3" valign="middle" id="StandardMaster_TableCell_12_<c:out value='${paramNumStatus}' />">
			<c:import  url="${billingAddressSelectListPath}" >
			    <c:param name="currentBillingAddress" value="${currentBillingAddress}"/>
				<c:param name="billingParmName" value="StandardMaster_billing_address_id_${paramNumStatus}" />
...
<!-- End - JSP File Name: StandardMasterCard.jsp -->
