...
<tr>
	<td id="WC_UserRegistrationUpdateForm_TableCell_16">
		<input class="logon input" type="password" maxlength="40" size="35" name="logonPassword" value="<c:out value="${logonPassword}"/>" id="WC_UserRegistrationUpdateForm_FormInput_logonPassword_1"/>
	</td>
</tr>
<tr>
...
<tr>
	<td id="WC_UserRegistrationUpdateForm_TableCell_17">
		<input class="logon input" type="password" maxlength="40" size="35" name="logonPasswordVerify" value="<c:out value="${logonPasswordVerify}"/>" id="WC_UserRegistrationUpdateForm_FormInput_logonPasswordVerify_1"/>
	</td>
</tr>
<tr>
