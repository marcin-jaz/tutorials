...
AccountWishListDisplay={	
	...
	*/	
	checkEmailForm:function (formId){
		...
		if(form.listId.value=='' || form.wishListHasItem.value=="false"){
	...
	/**
	* This function sets the boolen flag which indicates whether 'AjaxMyAccount' feature is enabled or not.
	* @param {string} val  the boolean value.
	*/	
	setAjaxVar: function(val)
	{
		this.ajaxMyAccountEnabled = val;
	},

	/**
	* This function returns the boolen value which indicates whether 'AjaxMyAccount' feature is enabled or not.
	* @return {string} ajaxMyAccountEnabled  the boolean value. 
	*/	
	getAjaxVar: function()
	{
