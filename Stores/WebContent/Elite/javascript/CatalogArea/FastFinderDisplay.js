 ...
 */
	...
	fastFinderJS={
					...
					+"<span class='primary_button button_fit' >\n"
						+"<span class='button_container' >\n"
							+"<span class='button_bg' >\n"
								+"<span class='button_top'>\n"
									+"<span class='button_bottom'>\n"			
										+"<a onclick='javascript: showPopup(\""+productObj.catentryId+"\",\""+this.storeId+"\",\""+this.langId+"\", \""+this.catalogId+"\", event, null, \"popupButton_"+ productObj.catentryId +"\")'  id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_link_2'>"+this.add2cart+"</a><br/>\n"
									+"</span>\n"
								+"</span>\n"
							+"</span>\n"
						+"</span>\n"
					...
					+"<span class='primary_button button_fit' >\n"
						+"<span class='button_container' >\n"
							+"<span class='button_bg' >\n"
								+"<span class='button_top'>\n"
									+"<span class='button_bottom'>\n"	
										+"<a onclick='javascript: showPopup(\""+productObj.catentryId+"\", \""+this.storeId+"\",\""+this.langId+"\", \""+this.catalogId+"\", event, null, \"popupButton_"+ productObj.catentryId +"\")'  id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_link_4'>"+this.add2cart+"</a><br/>\n"
									+"</span>\n"
								+"</span>\n"
							+"</span>\n"
						+"</span>\n"
				...
				if(productObj.baseContentHTML == null || productObj.baseContentHTML == ""){
					...
					if (viewType == "image") {
						...
						_baseContentNamePrice = _baseContentNamePrice
							...
							_baseContentNamePrice = _baseContentNamePrice
							+"<a href='"+productObj.productDisplayURL+"' id='img"+productObj.catentryId+"' class='fastfinderhover' onkeydown='javascript: shiftTabHidePopupButton("+ productObj.catentryId +", event);' onfocus='showPopupButton("+ productObj.catentryId +");' onmouseout='javascript:hideBackgroundImage(this);' onmouseover='javascript:showBackgroundImage(this);'>\n";
								...
								+"<span class='secondary_button button_fit' >\n"
									+"<span class='button_container' >\n"
										+"<span class='button_bg' >\n"
											+"<span class='button_top'>\n"
												+"<span class='button_bottom'>\n"
													+"<a href='#' onfocus='showPopupButton("+ productObj.catentryId +");' onclick='javaScript:showPopup(" +productObj.catentryId+","+this.storeId+","+this.langId+","+this.catalogId+", event, null, \"popupButton_"+ productObj.catentryId +"\");' onkeypress='javaScript:showPopup(" +productObj.catentryId+","+this.storeId+","+this.langId+","+this.catalogId+", event, null, \"popupButton_"+ productObj.catentryId +"\");' onblur='hidePopupButton("+ productObj.catentryId +");'  id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_link_5'>"+this.quickinfo+"</a>\n"
												+"</span>\n"
											+"</span>\n"
										+"</span>\n"
									+"</span>\n"
								...
								+"<td class='image' id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_td_1'>\n"
									...
									_baseContentNamePrice = _baseContentNamePrice
												+"<div class='left_nav' id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_div_13'>"
													+"<a href='"+productObj.productDisplayURL+"' id='img"+productObj.catentryId+"' class='fastfinderhover' onfocus='showPopupButton("+ productObj.catentryId +");' onkeydown='javascript: shiftTabHidePopupButton("+ productObj.catentryId +", event);' onmouseout='javascript:hideBackgroundImage(this);' onmouseover='javascript:showBackgroundImage(this);'>\n";
														if(this.dragVar == "true" && dojo.isIE == 6)
														{
															_baseContentNamePrice = _baseContentNamePrice
															+"<iframe class='productDnDIFrame' scrolling='no' frameborder='0' src='"+getImageDirectoryPath()+"images/empty.gif'></iframe>";
										...
										+"<span class='primary_button button_fit' >\n"
											+"<span class='button_container' >\n"
												+"<span class='button_bg' >\n"
													+"<span class='button_top'>\n"
														+"<span class='button_bottom'>\n"				
															+"<a onclick='javascript: showPopup(\""+productObj.catentryId+"\",\""+this.storeId+"\",\""+this.langId+"\", \""+this.catalogId+"\", event, null, \"popupButton_"+ productObj.catentryId +"\")' id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_link_8'>"+this.add2cart+"</a><br/>\n";
														+"</span>\n"
													+"</span>\n"
												+"</span>\n"
											+"</span>\n"
										...
										+"<span class='primary_button button_fit' >\n"
											+"<span class='button_container' >\n"
												+"<span class='button_bg' >\n"
													+"<span class='button_top'>\n"
														+"<span class='button_bottom'>\n"
															+"<a onclick='javascript: showPopup(\""+productObj.catentryId+"\", \""+this.storeId+"\",\""+this.langId+"\", \""+this.catalogId+"\", event, null, \"popupButton_"+ productObj.catentryId +"\")' id='WC_FastFinderDisplayJS_"+productObj.catentryId+"_link_10'>"+this.add2cart+"</a><br/>\n";
														+"</span>\n"
													+"</span>\n"
												+"</span>\n"
											+"</span>\n"
		...
		addElementToVector : function(targetVector, catentryId, SKU, name, identifierCounter, shortDescription, smallImageSrc, productCompareImagePath, mediumImageSrc, price, displayPrice, brand, productDisplayURL, dragSourceType, featuresArray, attrArray, baseContentHTML, toolTipHTML,entitledArray){
			...
			if(wcProduct.features[0] != null)
			{
				...
				if (fastFinderJS.allCatalogEntries[catentryId] != null && fastFinderJS.allCatalogEntries[catentryId] != "undefined")
				{
					...
					if (parseFloat(fastFinderJS.allCatalogEntries[catentryId].price) > parseFloat(fastFinderJS.allCatalogEntries[targetVector.elementAt(currentIndex+1)].price))
					{
		...
		* Displays the product set result message. 
		**/
		showTotalResultsMessage : function() {
			...
			if(resultsTD != null){
				...
				console.debug("totalResultsMessageDisplay"+" element is missing");
			}
		},
		...
		**/
		finishLoading: function(beginIndex) {
			...
			if ((this.catalogEntriesByPrice.size() < this.totalProductsInCategory || this.totalProductsInCategory == "UNDEFINED") && !fastFinderJS.firstSortLoaded)
			{
	...
	updatePriceRangeWidget: function(minPrice, maxPrice) 
		...
		**/
		enableFastFinderSelections: function()
		{
			...
			if (brandsForm.elements[0].disabled)
			{
