<!-- BEGIN CustomOfflineBillMe.jsp -->
<!-- This is CustomOfflineBillMe.jsp, a JSP fragment, and should not have <html> or <body> tags -->
...
<table cellpadding="3" cellspacing="0" border="0" id="CustomOfflineBillMe_Table_1">
	
<input type="hidden" name="piAmount" value="<c:out value="${edp_OrderTotalAmount}" />"	id="WC_CustomOfflineBillMe_FormInput_piAmount_1" />

	<%-- load billing address dropdown box from a seperate page --%>
	<tr>
		<td colspan="3" valign="middle" id="CustomOfflineBillMe_TableCell_1">
