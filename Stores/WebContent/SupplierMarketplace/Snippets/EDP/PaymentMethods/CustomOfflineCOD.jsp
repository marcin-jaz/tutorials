<!-- BEGIN CustomOfflineCOD.jsp -->
<!-- This is CustomOfflineCOD.jsp, a JSP fragment, and should not have <html> or <body> tags -->
...
<table cellpadding="3" cellspacing="0" border="0" id="CustomOfflineCOD_Table_1">

<input type="hidden" name="piAmount" value="<c:out value="${edp_OrderTotalAmount}" />"	id="WC_CustomOfflineCOD_FormInput_piAmount_1" />

	<%-- load billing address dropdown box from a seperate page --%>
	<tr>
		<td colspan="3" valign="middle" id="CustomOfflineCOD_TableCell_1">
