...
<table cellpadding="0" cellspacing="0" class="t_table" id="WC_AddressForm_Table_1">
	...
	<tr>
		<td class="t_td2" id="WC_AddressForm_TableCell_2">
			<span class="required">*</span><fmt:message key="EditAdd_REQUIRED" bundle="${storeText}"/>
		</td>
	</tr>
	<tr>
...
<input type="hidden" name="reloadStates" value="" id="WC_AddressForm_FormInput_reloadStates_1"/>
