...
<c:choose>
	...
	<fmt:message key="bidOverrideIntro" bundle="${auctionMessageText}" >
...
--%>	  
	...
	<fmt:message key="bestBid.info" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidrfn}" />
	</fmt:message>
	------------------------------------------------------------------- 
	<fmt:message key="bestBid.quantity" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidQuant}" />
	</fmt:message>
	<fmt:message key="bestBid.value" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidValue}" />
	</fmt:message>
	<fmt:message key="bestBid.dateTime" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidDate}" />
		<fmt:param value=" " />
	</fmt:message>
	<fmt:message key="bestBid.status" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidStatus}" />
	</fmt:message>
	<fmt:message key="bestBid.winValue" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidWinValue}" />
	</fmt:message>
	<fmt:message key="bestBid.winQuantity" bundle="${auctionMessageText}" >
		<fmt:param value="${bestBidWinQty}" />
	</fmt:message>
	<fmt:message key="bestBid.message" bundle="${auctionMessageText}" >
