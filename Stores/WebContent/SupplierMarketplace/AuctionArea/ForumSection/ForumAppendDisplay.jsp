...
<table border="0" cellpadding="0" cellspacing="0" width="790" id="WC_ForumAppendDisplay_Table_1">
<tr>
	

	<td valign="top" width="630" id="WC_ForumAppendDisplay_TableCell_2">
	...
	<c:if test="${auction_Status != 'R'}">
		...
		<c:if test="${!(posterId != userId && msgviewstatus != 'P')}">
			...
			<table cellpadding="0" cellspacing="8" border="0" id="WC_ForumAppendDisplay_Table_2">
				<tr>
					<td align="left" valign="top" class="categoryspace" width="100%" id="WC_ForumAppendDisplay_TableCell_3">
						<h1>
							<c:choose>
				...
				<tr>
					<td align="left" id="WC_ForumAppendDisplay_TableCell_4">
   						<font class="productName">
							<fmt:message key="Forum_messageId" bundle="${storeText}">
								<fmt:param value="${msg_id}" />
							</fmt:message>
						</font>   
						<br />
						<font class="productName">
							<fmt:message key="Forum_composedBy" bundle="${storeText}">
								<fmt:param value="${safname}" />
						...
						<br />
						<font class="productName">
							<fmt:message key="Forum_subjectId" bundle="${storeText}">
						...
						<table width="400" cellspacing="3" cellpadding="3" id="WC_ForumAppendDisplay_Table_3"> 
							<tr>
								<td width=320 align="left" id="WC_ForumAppendDisplay_TableCell_5">
									<font class="productName">
										<fmt:message key="Forum_respondMsg" bundle="${storeText}" />
									</font>
								</td>
							</tr>
						</table>
						<form name="compose" action="ShopperCreateForumMessage" id="compose">
							...
							<table width="360" cellspacing="3" cellpadding="3" id="WC_ForumAppendDisplay_Table_4">
								<tr>
									<td width=130 align="center" valign="middle" id="WC_ForumAppendDisplay_TableCell_6">  
										<input type="submit"  value="<fmt:message key="AuctionCommonText_Submit" bundle="${storeText}" />" 
											onclick="return CheckResubmit()" />
									</td>
									<td width=130 align="center" valign="middle" id="WC_ForumAppendDisplay_TableCell_7"> 
									...
									<form action="ShopperForumMsgListView" id="ShopperForumMsgListView">
										<input type="hidden" name="aucrfn" value="<c:out value="${aucrfn}" />" id="WC_ForumAppendDisplay_aucrfn_In_ShopperForumMsgListView"/>
										<input type="hidden" name="msgstatus" value="<c:out value="${msgstatus}" />" id="WC_ForumAppendDisplay_msgstatus_In_ShopperForumMsgListView"/>
										<input type="hidden" name="viewstatus" value="<c:out value="${viewstatus}" />" id="WC_ForumAppendDisplay_viewstatus_In_ShopperForumMsgListView"/> 
										<input type="hidden" name="forum_id" value="<c:out value="${forum_id}" />" id="WC_ForumAppendDisplay_forum_id_In_ShopperForumMsgListView"/>
									<td width=130 align="center" valign="middle" id="WC_ForumAppendDisplay_TableCell_8">  
										<input type="submit"  value="<fmt:message key="Forum_msgList" bundle="${storeText}" />" />
									</td>
									</form>      
								</tr> 
							</table> 
						    <table id="WC_ForumAppendDisplay_Table_5">
						    	...
						    	<c:choose>
						            ...
						            <td align="left" class="buttonStyle" id="WC_ForumAppendDisplay_TableCell_9">
										<font class="buttonStyle">
											<a href="AutoBidCreateForm?auctionStoreId=<c:out value="${auctionStoreId}" />&aucrfn=<c:out value="${aucrfn}" />" id="WC_ForumAppendDisplay_Link_1">
												<b>
												<fmt:message key="AuctionCommonText_newAutoBid" bundle="${storeText}" />
												</b>
											</a>/
											<a href="BidCreateForm?auctionStoreId=<c:out value="${auctionStoreId}" />&aucrfn=<c:out value="${aucrfn}" />" id="WC_ForumAppendDisplay_Link_2">
												<b>
							        ...
							        <td align="left" class="buttonStyle" id="WC_ForumAppendDisplay_TableCell_10">
										<font class="buttonStyle">
									      <a href="BidCreateForm?auctionStoreId=<c:out value="${auctionStoreId}" />&aucrfn=<c:out value="${aucrfn}" />" id="WC_ForumAppendDisplay_Link_3">
										      <b>
												<fmt:message key="AuctionCommonText_newBid" bundle="${storeText}" />
										      </b>
										  </a>
									...
									<c:otherwise>
										<td id="WC_ForumAppendDisplay_TableCell_11">
							            </td>
									</c:otherwise>
								</c:choose>
								<c:if test="${inGallery == false}">
						            <td align="left" class="buttonStyle" id="WC_ForumAppendDisplay_TableCell_12">
										<font class="buttonStyle">
								            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
								            <a href="UpdateGallery?storeId=<c:out value="${storeId}" />&aucrfn=<c:out value="${aucrfn}" />&GA=1&VR=1&URL=ShopperAuctionListView" id="WC_ForumAppendDisplay_Link_4">
									            <b>
						        ...
						        <tr> 
						            <td align="left" class="buttonStyle" id="WC_ForumAppendDisplay_TableCell_13">
										<font class="buttonStyle">
											<c:choose>
												<c:when test="${auction_Status == 'C'}">
													<a href="ProductDisplay?storeId=<c:out value="${storeId}" />&productId=<c:out value="${productId}" />&langId=<c:out value="${langId}" />&fromAuction=true" id="WC_ForumAppendDisplay_Link_5">
														<b>
												...
												<c:otherwise>
													<a href="DisplayAuctionItem?aucrfn=<c:out value="${aucrfn}" />&storeId=<c:out value="${storeId}" />&productId=<c:out value="${productId}" />&langId=<c:out value="${langId}" />&fromAuction=true" id="WC_ForumAppendDisplay_Link_6">
														<b>
														<fmt:message key="Forum_gotoProduct" bundle="${storeText}" />
														</b>
													</a>	
						            ...
						            <td align="left" class="buttonStyle" id="WC_ForumAppendDisplay_TableCell_14">
										<font class="buttonStyle">
							               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								           <b>
								           	<a href="ShopperAddMsgView?auctionStoreId=<c:out value="${auctionStoreId}" />&forum_id=<c:out value="${forum_id}" />&aucrfn=<c:out value="${aucrfn}" />" id="WC_ForumAppendDisplay_Link_7"> 
