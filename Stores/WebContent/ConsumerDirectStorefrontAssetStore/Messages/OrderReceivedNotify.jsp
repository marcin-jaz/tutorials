...
<html>
<head>
	<title><fmt:message key="STATUS_MESSAGE5" bundle="${storeText}"/></title>
...
<%@ include file="EmailHeader.jspf"%>
	...
	<h1><fmt:message key="STATUS_MESSAGE5" bundle="${storeText}"/></h1>

	<span class="text">
		<% out.flush(); %>
		<c:import url="${jspStoreDir}/Snippets/Marketing/Content/ContentSpotDisplay.jsp">
			<c:param name="spotName" value="Order_Received1" />
