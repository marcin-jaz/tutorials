						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<c:if test="${!empty param.maximizeURL}">
									<td class="portlet_maximize"><a href="<c:out value="${param.maximizeURL}"/>"><img src="<c:out value="${jspStoreImgDir}" />images/newmaximize.gif" alt="<c:out value="${param.HUDFrameTitle}"/>" width="10" height="10" border="0"/></a></td>
								</c:if>
							</tr>
						</table>
					</td>
