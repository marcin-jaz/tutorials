...
if (hshErrorProperties != null && strErrorMessageKey.equals("_ERR_NO_APPROVERS_IN_GROUP"))
	{
	incfile = jspStoreDir + "UserArea/AccountSection/UserAccountDisplay.jsp";
	...
	{
	incfile = jspStoreDir + "UserArea/AccountSection/RegistrationSubsection/UserRegistrationAddForm.jsp";
	...
	{
	incfile = jspStoreDir + "UserArea/AccountSection/RegistrationSubsection/UserRegistrationUpdateForm.jsp";
	%><jsp:include page="<%=incfile%>" flush="true"/><%
	}
%>
