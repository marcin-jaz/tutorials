...
<%-- 
  ...
  *	      - The protocol data fields for the payment method AMEX
  ...
  *				<c:import url="${snippetJspStoreDir}Snippets/EDP/PaymentMethods/StandardAmex.jsp" >
...
<table cellpadding="3" cellspacing="0" border="0" id="StandardAmex_Table_1_<c:out value='${paramNumStatus}' />">
	<tr>
		<td valign="middle" id="StandardAmex_TableCell_1_<c:out value='${paramNumStatus}' />">
			<label for="StandardAmex_InputText_1_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_AMEX_CARD_NUMBER" bundle="${edpText}"  /></label>
			
		</td>
		<td valign="middle" id="StandardAmex_TableCell_2_<c:out value='${paramNumStatus}' />">
			<label for="edp_Amex_cardExpiryMonth_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_AMEX_EXPIRATION_MONTH" bundle="${edpText}"  /></label>
		</td>
		<td valign="middle" id="StandardAmex_TableCell_3_<c:out value='${paramNumStatus}' />">
			<label for="edp_Amex_cardExpiryYear_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_AMEX_EXPIRATION_YEAR" bundle="${edpText}"  /></label>
		</td>
	</tr>
	<tr>
		<td valign="middle" id="StandardAmex_TableCell_4_<c:out value='${paramNumStatus}' />">
			<input class="input" type="text" name ="<c:out value="${inputPrefix}"/>account" value ="<c:out value="${account}" />" id="StandardAmex_InputText_1_<c:out value='${paramNumStatus}' />"
		...
		<td valign="middle" id="StandardAmex_TableCell_5_<c:out value='${paramNumStatus}' />" >
			<select name="<c:out value="${inputPrefix}"/>expire_month" class="select c_select_yr_mnth" id="edp_Amex_cardExpiryMonth_<c:out value='${paramNumStatus}' />" onchange="javascript:<c:out value='${edp_PI_Form}' />_changed('<c:out value='${inputPrefix}'/>expire_month')" >
		...
		<td valign="middle" id="StandardAmex_TableCell_6_<c:out value='${paramNumStatus}' />">
			<select name="<c:out value="${inputPrefix}"/>expire_year" class="select c_select_yr_mnth" id="edp_Amex_cardExpiryYear_<c:out value='${paramNumStatus}' />" onchange="javascript:<c:out value='${edp_PI_Form}' />_changed('<c:out value='${inputPrefix}'/>expire_year')">
   ...
   <%-- The section to collect the amount for this payment method --%>
	...
	<tr>
		...
		***************************
		--%>
		<td id="StandardAmex_TableCell_7_<c:out value='${paramNumStatus}' />">
			<label for="StandardAmex_OrderRemainingAmount_<c:out value='${paramNumStatus}' />"><fmt:message key="EDPPaymentMethods_PAYMENT_AMT_REMAINING" bundle="${edpText}"/></label>
		</td>
	</tr>
	<tr>
		<td id="StandardAmex_TableCell_8_<c:out value='${paramNumStatus}' />">
			<input <c:if test="${remainingAmt lt 0.0}"> class="error" </c:if>
				class="input" type="text" name="remainingAmount" id="StandardAmex_OrderRemainingAmount_<c:out value='${paramNumStatus}' />" readonly="readonly" value="<c:out value="${remainingAmt}"/>" />
		</td>
	</tr>
	</c:if>
	<tr>
		<td colspan="3" valign="middle" id="StandardAmex_TableCell_9_<c:out value='${paramNumStatus}' />">
			<label for="StandardAmex_InputText_3_<c:out value='${paramNumStatus}' />"><span class="required">*</span><fmt:message key="EDPPaymentMethods_PAYMENT_AMOUNT" bundle="${edpText}"/></label>
		</td>
	</tr>
	<tr>
		<td colspan="3" valign="middle" id="StandardAmex_TableCell_10_<c:out value='${paramNumStatus}' />">
			<input class="input" type="text" name = "<c:out value="${inputPrefix}"/>piAmount" value="<c:out value="${edp_PayMethodAmount}" />" id="StandardAmex_InputText_3_<c:out value='${paramNumStatus}' />"  onchange="javascript:<c:out value='${edp_PI_Form}'/>_amount_changed('<c:out value='${inputPrefix}'/>piAmount') "/>
		</td>
	</tr>
	</c:if>
	...
	<tr>
		<td colspan="3" valign="middle" id="StandardAmex_TableCell_12_<c:out value='${paramNumStatus}' />">
			<c:import  url="${billingAddressSelectListPath}" >
			    <c:param name="currentBillingAddress" value="${currentBillingAddress}"/>
				<c:param name="billingParmName" value="StandardAmex_billing_address_id_${paramNumStatus}" />
