...
<%--
  * This ProductCrossSellAssocESpot.jsp file is built as a sample snippet to display an e-Marketing Spot in a
  ...
  *		<c:import url="${jspStoreDir}include/ProductCrossSellAssocESpot.jsp">
...
<!-- BEGIN ProductCrossSellAssocESpot.jsp -->
	...
	<c:forEach var="marketingSpotData" items="${marketingSpotDatas.baseMarketingSpotActivityData}" varStatus="status">
		<c:if test='${marketingSpotData.dataType eq "CatalogEntry"}'>
			...
			<c:if test='${status.count==1}'>
				<tr>
					<td class="tblue" colspan="2" height="20" width="150" id="<c:out value="${marketing_TableCell_ID_Prefix}" /><c:out value="${marketing_TableCellCounter }" />">&nbsp;&nbsp;<fmt:message key="ProductCrossSellDisplay_Title" bundle="${storeText}" /></td>
				</tr>
			...
			<tr>
				<td valign="top" align="center" width="150" id="<c:out value="${marketing_TableCell_ID_Prefix}" /><c:out value="${marketing_TableCellCounter + 1}" />">
					...
					<a href="<c:out value="${marketing_ClickInfoURL}"/>" id="<c:out value="${marketing_Link_ID_Prefix}" /><c:out value="${marketing_LinkCounter}" />">
						<img src="<c:out value="${hostPath}"/><c:out value="${imageFilePath}"/><c:out value="${marketing_CatalogEntryThumbNail}"/>" width="90" height="90" alt="<c:out value="${marketing_CatalogEntryName}" escapeXml="false"/>" hspace="5" border="0" align="center" />
					</a>
				</td>
			</tr>
			<tr>
				<td class="small" align="left" valign="top" width="150" id="<c:out value="${marketing_TableCell_ID_Prefix}" /><c:out value="${marketing_TableCellCounter + 2}" />">
					<br />
...
<!-- END ProductCrossSellAssocESpot.jsp -->
