...
<html>
	<head>
		<title><%=storeText.getString("CSRF_ERROR_TITLE")%></title>
		...
		<!-- Start Main JSP Content -->
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							<tbody>
								...
								<tr>
									<td width="100%"><span class="title1"><%=storeText.getString("CSRF_ERROR_TITLE")%></span></td>
									<td></td>
								</tr>
								<tr>
									<td width="100%"><br />
										<%=storeText.getString("CSRF_ERROR_DESC")%><br />
										<br />
									</td>
								</tr>
							</tbody>
