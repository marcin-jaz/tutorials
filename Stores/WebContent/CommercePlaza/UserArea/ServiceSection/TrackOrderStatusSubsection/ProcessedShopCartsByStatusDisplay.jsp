...
<table border="0" cellpadding="0" cellspacing="0" width="750" height="99%">
  <tr>
    ...
    <td valign="top" width="590">
      ...
      <form name="TimeRange" action="ProcessedShopCartsByStatusDisplayView" method="post">
            ...
            <tr>
              <td>
                <table>
                  ...
                  <tr>
                    <td><b><%=storeText.getString("OrderList_OrdersFrom")%></b></td>
                    <td> 
              ...
              <td>
                <table cellpadding="1" cellspacing="1" border="0" width="590">
                  ...
                  <tr>
                    ...
                    <td colspan="4" align="right"><b><%=storeText.getString("DistributorCarts_SortBy")%> <%=storeText.getString("DistributorCarts_Status")%> | <a href="ProcessedShopCartsByDescriptionDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Description")%></a> | <a href="ProcessedShopCartsByDateDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Date")%></a></b>&nbsp;&nbsp;</td>
                  </tr>                
                  <tr class="tdblue">
