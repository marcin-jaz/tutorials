...
request.setAttribute("pageName", "OrderStatus");
...
String [] statusChar = {"P", "W", "N", "F", "C", "S", "I","SP","BP","X" };
String [] orderStatus = {storeText.getString("DistributorCartStatus_P"),
                         storeText.getString("DistributorCartStatus_W"),
...
orderListBean.setSortMethodId(4); // sort by order description
...
for (int j = 0; j < orders.length; j++) {
    if ((orders[j].getParentOrder().getDescription() != null)) {
...
<head>
    <title><%=storeText.getString("OrderStatus_Title")%></title>
      ...
      <table width="590" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="590" colspan="2"><span class="bct">&nbsp;&nbsp;&nbsp;</span>
            ...
            <font class="bct"><%=storeText.getString("Breadcrumb_OrderStatus")%></font>
          </td>
        </tr>
        <tr>
          <td valign="top" width="320"><div align="left"><span class="title"><%=storeText.getString("OrderStatus_Title")%></span></div></td>
          <td valign="top" width="280"><div align="right"><img src="<%=fileDir%>images/hdr_cart.gif" width="280" height="72" alt="<%=storeText.getString("OrderStatus_Status")%>"></div></td>
        </tr>
        <tr>
          <td width="590" height="1" colspan="3"><img src="<%=fileDir%>images/c.gif" width="2" height="1" class="imgHeightFix"  /></td>
        </tr>
      </table>  
      <form name="TimeRange" action="ProcessedShopCartsByDescriptionDisplayView" method="post">
            ...
            <tr>
              <td>
                <table>
                  ...
                  <tr>
                    <td><b><%=storeText.getString("OrderList_DistributorCartsFrom")%></b></td>
                    <td> 
            ...
            <tr>
              <td> 
                <table cellpadding="0" cellspacing="1" border="0" width="590">
                  <tr>
                    <td><%=storeText.getString("OrderStatus_NoOrder")%></td>
                  </tr>
<% } else { %>              
            <tr>
              <td>
                <table cellpadding="1" cellspacing="1" border="0" width="590">
                  <tr>
                    <td colspan="7"><img src="<%=fileDir%>images/c.gif" width="1" height="11" border="0" /></td>
                  </tr>                
                  <tr>
                    <td colspan="3"><b><%=storeText.getString("OrderList_DistributorOf", new Integer((currentPageNumber-1)*pageSize+1).toString(), new Integer(Math.min(currentPageNumber*pageSize,total)).toString(), new Integer(total).toString())%></b></td>
                    <td colspan="4" align="right"><b><%=storeText.getString("DistributorCarts_SortBy")%><a href="ProcessedShopCartsByStatusDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Status")%></a> | <%=storeText.getString("DistributorCarts_Description")%> | <a href="ProcessedShopCartsByDateDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Date")%></a></b>&nbsp;&nbsp;</td>
                  </tr>                
                  <tr class="tdblue">
                    <td colspan="7" height="18" class="tdblue">&nbsp;&nbsp;<%=storeText.getString("OrderStatus_Status")%></td>
                  </tr>
                  <tr valign="top"> 
                    ...
                    <th id="t3" width="80" align="left" valign="top" class="mbg">
                      <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td height="18"><img src="<%=fileDir%>images/c.gif" width="2" height="1" /></td><td align="left" valign="top"><span class="small" style="font-weight: bold"><%=storeText.getString("DistributorCarts_Distributor")%></span></td>
                        </tr>
                      </table>
                    </th>
                    ...
                    <th id="t5" align="left" valign="top" class="mbg">
                      <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td height="18"><img src="<%=fileDir%>images/c.gif" width="2" height="1" /></td>
                          <td align="left" valign="top"><span class="small" style="font-weight: bold"><%=storeText.getString("DistributorCarts_Date1")%></span></td>
                        </tr>
                      </table>
                    </th>
                    <th id="t6" width="80" align="left" valign="top" class="mbg">
                      <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td height="18"><img src="<%=fileDir%>images/c.gif" width="2" height="1" /></td>
                    ...
                    <th id="t7" align="left" valign="top" class="mbg">
                      <table cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td height="18"><img src="<%=fileDir%>images/c.gif" width="2" height="1" /></td>
...
<%
	  ...
	  stEntDscAccessBean = stEntDataBean.getDescription(new Integer(languageId));
          ...
          if ((orderBean.getParentOrder().getDescription() != null)) {
...
%>
                  <tr>
                    <td headers="t1" height="19" align="left" valign="top"><span class="small"><%= orderDesc %></span></td>
                    <td headers="t2" height="19" align="left" valign="top"><span class="small"><a href="ProcessedDistributorCartDetailsDisplayView?orderId=<%= orderBean.getOrderId()%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%= orderBean.getOrderId() %></a></span></td>
                    <td headers="t3" height="19" align="left" valign="top"><span class="small"><%= distributorName %></span></td>
<%
            String statusValue = "";
            String status = "";
...
<%          } %>
                    ...
                    <td headers="t6" align="left" nowrap valign="top"><span class="small"><%= statusValue %></span></td>
                    <td headers="t7" align="right" valign="top"><span class="small"><%= orderBean.getFormattedTotalProductPrice() %></span></td>
                  </tr>
