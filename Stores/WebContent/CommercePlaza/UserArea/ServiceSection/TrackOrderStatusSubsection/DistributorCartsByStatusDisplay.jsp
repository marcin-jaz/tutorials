...
<table border="0" cellpadding="0" cellspacing="0" width="750" height="99%">
  <tr>
    ...
    <td valign="top" width="590">
      ...
      <form name="TimeRange" action="DistributorCartsByStatusDisplayView" method="post">
              ...
              <td>
                <table cellpadding="1" cellspacing="1" border="0" width="590">
                  ...
                  <tr>
                    ...
                    <td colspan="4" align="right"><b><%=storeText.getString("DistributorCarts_SortBy")%> <%=storeText.getString("DistributorCarts_Status")%> | <a href="DistributorCartsByDistributorDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Distributor")%></a> | <a href="DistributorCartsByDateDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("OrderList_LastUpdated")%> / <%=storeText.getString("DistributorCarts_Date")%></a></b></td>
                  </tr>                
                  <tr class="tdblue">
