...
orderListBean.setSortMethodId(9); // sort by time placed
...
<table border="0" cellpadding="0" cellspacing="0" width="750" height="99%">
  <tr>
    ...
    <td valign="top" width="590">
      ...
      <form name="TimeRange" action="ProcessedShopCartsByDateDisplayView" method="post">
              ...
              <td>
                <table cellpadding="1" cellspacing="1" border="0" width="590">
                  ...
                  <tr>
                    ...
                    <td colspan="4" align="right"><b><%=storeText.getString("DistributorCarts_SortBy")%> <a href="ProcessedShopCartsByStatusDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Status")%></a> | <a href="ProcessedShopCartsByDescriptionDisplayView?storeId=<%=storeId%>&catalogId=<%=catalogId%>&langId=<%=languageId%>"><%=storeText.getString("DistributorCarts_Description")%></a> | <%=storeText.getString("DistributorCarts_Date")%></b>&nbsp;&nbsp;</td>
                  </tr>                
                  <tr class="tdblue">
