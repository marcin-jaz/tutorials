			...
			if(hiddenField != null){
                ...
                if (userDisplayNameField != null){
                        ...
                        if (logonUserCookie != null){
                        	dojo.cookie("WC_LogonUserId_"+WCParamJS.storeId, null, {expires:-1,path:'/'});
                        }
                        dojo.cookie("WC_LogonUserId_"+WCParamJS.storeId, userDisplayNameField.value , {path:'/'});
                        ...
                        if (updateLogonUserCookie != undefined || updateLogonUserCookie != ""){
                	       ...
                	       var signOutQuickLinkUser = dojo.byId(idPrefix + "signOutQuickLinkUser");
                               if(signOutQuickLinkUser != null){
                                        signOutQuickLinkUser.innerHTML =  logonUserName;
                                }
        
                                //if shop on behalf is enabled, update the link.
                                if(dojo.exists("GlobalLoginShopOnBehalfJS")){
                                ...
                                var signOutQuickLinkUser = dojo.byId(idPrefix + "signOutQuickLinkUser");
                                if(signOutQuickLinkUser != null){
                                        signOutQuickLinkUser.innerHTML  =  userDisplayNameField.value;
                                }
                                if(dojo.exists("GlobalLoginShopOnBehalfJS")){
                                        GlobalLoginShopOnBehalfJS.updateSignOutLink(widget.id);
                                        GlobalLoginShopOnBehalfJS.initializePanels();
                ...
                if(displayContractPanel != undefined && displayContractPanel != null && displayContractPanel.toString() == "true"){
                        dojo.cookie("WC_DisplayContractPanel_"+WCParamJS.storeId, null, {expires:-1,path:'/'});	
                }
