	...
	/**
        ...
        */     
        initHTTPSecure:function(){
                ...
                dojo.cookie("WC_DisplayContractPanel_"+WCParamJS.storeId, true, {path: "/"});
                dojo.cookie("WC_ToogleOnBehalfPanel_"+WCParamJS.storeId, true, {path: "/"});
        ...
        initializePanel : function(shopOnBehalfPanelId, shopForSelfPanelId){
                ...
                if(isInitialized == null || !isInitialized){
                        ...
                        if(toogleOnBehalfPanel != null && toogleOnBehalfPanel){
                                ...
                                //delete the cookie.
                                dojo.cookie("WC_ToogleOnBehalfPanel_"+WCParamJS.storeId, null, {path: "/", expires : -1}); 
                        }
                }
                var callerId = "";
   ...
   */        
	selectUser: function(userDropDown){
      ...
      if(!submitRequest()){
			...
			cursor_wait();
			wc.service.invoke("RunAsUserSetInSessionService", {'runAsUserId' : selectedUser.userId});
		}
	},
        ...
        */        
        onUserSetInSession: function(){
                ...
                //write the cookie.
                dojo.cookie("WC_BuyOnBehalf_"+WCParamJS.storeId, selectedUser.fullName, {path:'/'});
        ...
        */         
        ...
        /**
        *This method clears the user set in session. It restores the session to that of the buyer admin.
        */        
        clearUserSetInSession: function(link){
        ...
        onRestoreUserSetInSession: function(){
                //clear the cookie
                dojo.cookie("WC_BuyOnBehalf_"+WCParamJS.storeId, null, {path: '/', expires: -1});
                var widgetIds = GlobalLoginJS.widgetsLoadedOnPage;
                if (widgetIds != null && widgetIds.length > 0){
                	for (var i = 0; i < widgetIds.length; i++) {
                		this.updateSignOutLink(widgetIds[i]);
	...
	updateSignOutLink: function(widgetId){
        ...
        deleteBuyerUserNameCookie: function(){
                dojo.cookie("WC_BuyOnBehalf_"+WCParamJS.storeId, null, {expires: -1, path: '/'});
                var widgetIds = GlobalLoginJS.widgetsLoadedOnPage;
                if (widgetIds != null && widgetIds.length > 0){
                	for (var i = 0; i < widgetIds.length; i++) {
                		this.updateSignOutLink(widgetIds[i]);
...
wc.service.declare({
	...
	url: "AjaxRestoreOriginalUserSetInSession",
	formId: ""
