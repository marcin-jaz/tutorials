...
/*
		...
		restoreHistoryContext:function() {
			if(location.hash != null && location.hash != "" && location.hash != "#") {
				...
				wc.render.updateContext('searchBasedNavigation_context', {"productBeginIndex": productBeginIndex, "orderBy": orderBy, "pageView": pageView, "facet": facetArray[0], "facetLimit": facetArray[1], "facetId": facetArray[2], "minPrice": minPrice, "maxPrice": maxPrice, "pageSize": pageSize});
			}
			else {
				this.updateHistory();
			}
