...
<script type="text/javascript">
	dojo.addOnLoad(function() { 
		...
		SBServicesDeclarationJS.setCommonParameters('${WCParam.langId}','${WCParam.storeId}','${WCParam.catalogId}');
		SBServicesDeclarationJS.setAjaxCheckOut('${isAjaxCheckOut}');
		CommonContextsJS.setCommonParameters('${WCParam.langId}','${WCParam.storeId}','${WCParam.catalogId}');
	...
	<%@ include file="../../include/LayoutContainerTop.jspf"%>
     ...
     <!-- Breadcrumb Start -->
		...
		<div class="crumb" id="WC_SingleShipmentDisplay_div_4">
			...
			<a href="<c:out value="${ShoppingCartURL}"/>" id="WC_SingleShipmentDisplay_links_1"><span><fmt:message key="BCT_SHOPPING_CART" bundle="${storeText}"/></span></a> | 
						   	...
						   	wc.render.declareContext("paymentContext", {payment1: "empty", payment2: "empty", payment3: "empty", currentAreaNumber: "1", billingMode1: "none", billingMode2: "none", billingMode3: "none",currentTotal:"0"},	"");
								...
								wc.render.declareRefreshController({
										...
										refreshHandler:function(widget,data){
											var total = eval('(' + data + ')');
											var updatedTotal = total["orderTotal"];
											CheckoutPayments.updateAmountFields(updatedTotal);
										},
