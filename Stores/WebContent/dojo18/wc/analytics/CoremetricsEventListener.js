		...
		for(x in obj) {
			if(x == PARAM_OPTIONS) {
				...
				if (!useDDX) {
					...
					if(x == this.PARAM_EXTRA_PARAM) {
						extraParams = obj[x];
					} else if(x == this.PARAM_ATTRIBUTES) {
						attributes = obj[x];
					}
				}
			}
				...
				for(x in values) {
					if(x == PARAM_PRODUCTID) {
						...
						if (!useDDX) {
							...
							if(x == this.PARAM_ATTRIBUTES) {
								attributes = values[x];
							} else if(x == this.PARAM_VIRTUAL_CATEGORY) {
				...
				for(x in values) {
					if(x == PARAM_PRODUCTID) {
						...
						if (!useDDX) {
							...
							if(x == this.PARAM_ATTRIBUTES) {
								attributes = values[x];
							} else if(x == this.PARAM_EXTRA_PARAM) {
								extraParams = values[x];
							}
						}
					}
