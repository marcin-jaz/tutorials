				...
				<form name="Register" method="post" action="RESTUserRegistrationUpdate" id="Register">
					...
					<div class="column" id="WC_UserRegistrationUpdateForm_div_13">
						<div id="WC_UserRegistrationUpdateForm_div_14" class="column_label">
							...
							<fmt:message bundle="${storeText}" key="PASSWORD3" />
						</div>
						<input size="35" class="inputField" maxlength="50" name="logonPassword_old" type="password" autocomplete="off" value="" id="WC_UserRegistrationUpdateForm_FormInput_logonPassword_In_Register_1"/>
					</div>
					...
					<div class="column" id="WC_UserRegistrationUpdateForm_div_16">
						<div id="WC_UserRegistrationUpdateForm_div_17" class="column_label">
							<label for="WC_UserRegistrationUpdateForm_FormInput_logonPasswordVerify_In_Register_1" class="nodisplay">
								<fmt:message bundle="${storeText}" key="AB_ADDRESS_LABEL_TEXT" >
								<fmt:param><fmt:message bundle="${storeText}" key="VERIFY_PASSWORD3" /></fmt:param>
								<fmt:param> </fmt:param></fmt:message>
							</label>
							<fmt:message bundle="${storeText}" key="VERIFY_PASSWORD3" />
						</div>
						<input size="35" class="inputField" maxlength="50" name="logonPasswordVerify_old" type="password" autocomplete="off" value="" id="WC_UserRegistrationUpdateForm_FormInput_logonPasswordVerify_In_Register_1"/>
					</div>
