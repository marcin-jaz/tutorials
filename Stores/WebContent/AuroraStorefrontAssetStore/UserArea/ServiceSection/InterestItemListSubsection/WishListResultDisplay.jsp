		...
		<flow:ifEnabled feature="RemoteWidget">
			<c:if test="${!empty defaultWishList}">		
				<div class="right" id="getWidgetButton">
					<c:url var="feedURL" value="${restURLScheme}://${pageContext.request.serverName}:${restURLPort}${restURI}/stores/${WCParam.storeId}/GiftLists/${selectedWishListId}?guestAccessKey=${defaultWishList.guestAccessKey}">
