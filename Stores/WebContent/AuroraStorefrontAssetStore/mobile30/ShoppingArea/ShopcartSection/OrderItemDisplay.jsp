	...
	<body>
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<form name="wishListItemAddForm" id="wishListItemAddForm" action="RestWishListAddItem">
							...
							<input type="hidden" name="catEntryId_1" value="" id="catEntryId" />
						...
						<wcf:url var="PromotionCodeManageURL" value="RESTPromotionCodeApply">
							...
							<wcf:param name="URL" value="OrderCalculate?calculationUsageId=-1&URL=AjaxOrderItemDisplayView" />
		...
		<script type="text/javascript">
			...
			function mUpdateCartCookies(cartAmount,cartQuantity,cartCurrency) {
				...
				if(cartOrderId != ""){
					dojo.cookie("WC_CartTotal_"+cartOrderId, cartQuantity + ";" + cartAmount + ";" + cartCurrency + ";" + ${langId}, {path:'/'});
				}
			}
			...
			function createAndAddToDefaultWishList(listCount) {
				<c:choose>
					...
					<c:when test="${defaultShoppingListId == -1}">
						document.getElementById("wishListItemAddForm").action = "RestWishListCreate";
