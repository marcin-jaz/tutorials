			...
			<form id="my_account_personal_information_form" method="post" action="RESTUserRegistrationUpdate">
				...
				<div id="my_account_personal_information1" class="item_wrapper">
					<fieldset>						
						...
						<input type="password" id="WC_MUserRegistrationUpdateForm_FormInput_logonPassword" name="logonPasswordOld" value="${logonPassword}" class="inputfield input_width_standard" />		
						...
						<input type="password" id="WC_MUserRegistrationUpdateForm_FormInput_logonPasswordVerify" name="logonPasswordVerifyOld" value="${logonPasswordVerify}" class="inputfield input_width_standard" />
						<div class="item_spacer"></div>
						...
						<input type="text" id="WC_MUserRegistrationUpdateForm_FormInput_firstName" name="firstName" value="${firstName}" class="inputfield input_width_standard" />
						<div class="item_spacer"></div>
						...
						<input type="text" id="WC_MUserRegistrationUpdateForm_FormInput_lastName" name="lastName" value="${lastName}" class="inputfield input_width_standard" />
						<div class="item_spacer"></div>
						...
						<input type="email" id="WC_MUserRegistrationUpdateForm_FormInput_email1" name="email1" value="${email1}" class="inputfield input_width_standard" />
					</fieldset>
				</div>
