		...
		<div id="page">
			...
			<div id="content_wrapper_border">
				<div id="box" class=" my_account generic_error_container">
					...
					<div id="WC_CSRFErrorDisplay_1" class="contentgrad_header">
						<div id="WC_CSRFErrorDisplay_2" class="left_corner"></div>
						<div id="WC_CSRFErrorDisplay_3" class="left"><h1 class="myaccount_title"><fmt:message key="CSRF_ERROR_TITLE" bundle="${storeText}" /></h1></div>
						<div id="WC_CSRFErrorDisplay_10" class="right_corner"></div>
					</div>
									...
									<span class="button_bg">
										<span class="button_top">
											<span class="button_bottom">   
												<a href="javascript:history.back(1)" id="WC_CSRFError_Link_1">
