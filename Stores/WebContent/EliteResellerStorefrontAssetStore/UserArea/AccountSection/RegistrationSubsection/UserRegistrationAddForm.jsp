...
<![endif]-->
	...
	<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/UserArea/LogonForm.js"/>"></script>
      ...
      <script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/UserArea/B2BOrgTooltip.js"/>"></script>
	...
	<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/UserArea/MyAccountDisplay.js"/>"></script>
      ...
      <script type="text/javascript">
         dojo.addOnLoad(function() {
         	parseWidget("buyerOrgToolTipSection");
      ...
      <%@ include file="B2BUserRegistrationAddExt.jspf" %>

   </head>



   <wcf:url var="TopCategoriesDisplayURL" value="LogonForm">
   ...
   <body>
      ...
      <div id="page">
         ...
         <form name="Register" method="post" action="UserRegistrationAdd" id="Register">
            ...
            <input type="hidden" name="URL" value="StoreView?page=account&ancestorOrgs*=&logonId*=&firstName*=&lastName*=&address1*=&address2*=&city*=&country*=&state*=&zipCode*=&email1*=&phone1*=" id="WC_UserRegistrationAddForm_FormInput_URL_In_Register_1"/>
            ...
            <input type="hidden" name="profileType" value="B" id="WC_UserRegistrationAddForm_FormInput_profileType_In_Register_1"/>
			<input type="hidden" name="parentMember" id="WC_UserRegistrationAddForm_FormInput_parentMember_1"  />			
                     ...
                     <div class="form" id="WC_UserRegistrationAddForm_div_3">
                        <div class="header_registration" id="WC_UserRegistrationAddForm_div_4">
                           <div class="heading" id="WC_UserRegistrationAddForm_div_5">
                              <h2 class="black"><fmt:message key="UR_PLEASE_REG" bundle="${storeText}"/></h2>
                           </div>
                        </div>
                              ...
                              <div class="form_2column" id="WC_UserRegistrationAddForm_div_8">
                                 ...
                                 <div class="column" id="WC_UserRegistrationAddForm_div_19">
                                    <div id="WC_UserRegistrationAddForm_div_20">
                                       <label for="WC_UserRegistrationAddForm_FormInput_email1_In_Register_1"><div class="required-field" id="WC_UserRegistrationAddForm_div_21"> *</div>
                                 ...
                                 <div class="column" id="WC_UserRegistrationAddForm_div_22">
                                    <div id="WC_UserRegistrationAddForm_div_23">
                                       ...
                                       <fmt:message key="PHONE_NUMBER2" bundle="${storeText}"/></label>
                                    </div>
                        ...
                        <div class="clear_both"></div>
                        <div class="twisty_align" id="WC_UserRegistrationAddForm_div_40">
			            <span class="primary_button button_fit" id="WC_AccountDisplay_div_24_1">
							<span class="button_container">
								<span class="button_bg">
									<span class="button_top">
										<span class="button_bottom">   
											 <a href="#" onclick="JavaScript:submitForm(document.Register);" id="WC_UserRegistrationAddForm_links_1">	
			            ...
			            <span class="secondary_button button_fit" id="WC_AccountDisplay_div_24_2">
							<span class="button_container">
								<span class="button_bg">
									<span class="button_top">
										<span class="button_bottom">
											<a href="<c:out value="${TopCategoriesDisplayURL}"/>" class="light_button" id="WC_UserRegistrationAddForm_links_2">   
