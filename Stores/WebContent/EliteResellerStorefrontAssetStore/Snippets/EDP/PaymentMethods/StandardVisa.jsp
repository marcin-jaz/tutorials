...
<div class="card_info" id="WC_StandardVisa_div_1">
	<c:choose>
	...
	<input type="hidden" name="cc_brand" value="<c:out value="${cc_brand}" />" id="WC_StandardVisa_inputs_1"/>
	<input type="hidden" name="paymentTCId" value="<c:out value="${paymentTCId}"/>" id="WC_StandardVisa_inputs_2"/>
	...
	<span class="col1">
		<span class="card_number">
			<span>
				<label for="edp_Visa_account_<c:out value='${paymentAreaNumber}' />"><span class="required-field">*</span><fmt:message key="EDPPaymentMethods_VISA_CARD_NUMBER" bundle="${storeText}"/></label>
			</span>
			<span>
		...
		<span class="visaCVV2">
			<span id="CVVDetailsSection">					
				<span id="StandardVisa_CVVDetails_${paymentAreaNumber}" class="order_link" tabindex="0"><fmt:message key="EDPPaymentMethods_CVV_WHAT_IS" bundle="${storeText}"/></span>
				<span id="StandardVisa_CVVDetails_${paymentAreaNumber}_span_2" dojoType="wc.widget.Tooltip" connectId="StandardVisa_CVVDetails_${paymentAreaNumber}" style="display: none;">
					<div id="tooltip_popup">
						<div id="WC_StandardVisa_div_2" class="header">
							<div id="WC_StandardVisa_div_3" class="close">
								<fmt:message key="EDPPaymentMethods_CVV_WHAT_IS" bundle="${storeText}"/>
							</div>
						</div>
						<div id="WC_StandardVisa_div_4" class="bodyarea">
							<div id="WC_StandardVisa_div_5" class="bodycontent">
								<fmt:message key="EDPPaymentMethods_CVV_DEFINITION" bundle="${storeText}"/>
							</div>
						</div>
						<div id="WC_StandardVisa_div_6" class="footer"></div>
