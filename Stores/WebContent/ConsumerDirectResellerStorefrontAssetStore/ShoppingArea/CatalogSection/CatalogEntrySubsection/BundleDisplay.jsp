...
<head>
<title><fmt:message key="BUNDLE_TITLE" bundle="${storeText}" /></title>
<meta name="description" content="<c:out value="${bundle.description.longDescription}"/>"/>
<meta name="keyword" content="<c:out value="${bundle.description.keyWord}"/>"/>
...
<table align="center" cellpadding="2" cellspacing="0" width="786" border="0" id="WC_BundleDisplay_Table_11">
	<tbody>
		<tr align="center">
			<td>
