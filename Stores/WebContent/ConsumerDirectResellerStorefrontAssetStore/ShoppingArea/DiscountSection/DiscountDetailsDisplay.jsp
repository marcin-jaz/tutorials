...
<%@ include file="../../include/LayoutContainerTop.jspf"%>
	...
	<table align="center" cellpadding="0" cellspacing="0" width="786" border="0" id="WC_DiscountDetailsDisplay_Table_1">
	<tbody>
...
<c:choose>
	<c:when test="${ !empty calculationCodeDBs }"  >
		<tr>
			<td valign="top" id="WC_DiscountDetailsDisplay_TableCell_7">
		...
		<tr>
			<td valign="top" id="WC_DiscountDetailsDisplay_TableCell_8">
										...
										<td valign="top" align="center" id="WC_DiscountDetailsDisplay_TableCell_11_<c:out value="${counter.count}"/>">
											...
											<c:choose>
												<c:when test="${catalogEntry.product}">
													...
													<c:set var="catalogEntry" value="${catalogEntry.productDataBean}"/>
	...
	<c:otherwise>
		<tr>
			<td id="WC_DiscountDetailsDisplay_TableCell_12">
