...
<tr>
	<td id="WC_OrgRegAddFormUserSection_TableCell_6"><input id="WC_OrgRegAddFormUserSection_FormInput_password_1" class="logon input" type="password" autocomplete="off" maxlength="40" size="35" name="logonPassword" value="<c:out value="${WCParam.logonPassword}"/>"/></td>
</tr>
<tr>
...
<tr>
	<td id="WC_OrgRegAddFormUserSection_TableCell_7"><input id="WC_OrgRegAddFormUserSection_FormInput_password_verify_1" class="logon input" type="password" autocomplete="off" maxlength="40" size="35" name="logonPasswordVerify" value="<c:out value="${WCParam.logonPasswordVerify}"/>"/></td>
</tr>
<tr>
