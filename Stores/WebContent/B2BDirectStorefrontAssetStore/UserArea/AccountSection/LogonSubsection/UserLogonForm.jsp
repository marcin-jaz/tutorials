												...
												<table cellpadding="0" cellspacing="0" border="0" id="WC_UserLogonForm_Table_5">
													...
													<tr>
														<td id="WC_UserLogonForm_TableCell_16">
															<input type="password" autocomplete="off" size="25" class="logon" name="logonPassword" id="WC_UserLogonForm_FormInput_logonPassword_In_LogonForm_1" onfocus="this.onkeypress = pressEnter;"/>
														</td>
													</tr>
													<tr>
