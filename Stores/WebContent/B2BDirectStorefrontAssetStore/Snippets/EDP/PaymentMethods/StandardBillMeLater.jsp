...
<%-- 
  ...
  *	      - The protocol data fields for the payment method BillMe
  ...
  *				<c:import url="${snippetJspStoreDir}Snippets/EDP/PaymentMethods/StandardBillMeLater.jsp" >
...
<!-- Start - JSP File Name: StandardBillMeLater.jsp -->
...
<table cellpadding="3" cellspacing="0" border="0" id="StandardBillMe_Table_1_<c:out value='${paramNumStatus}' />" >
	...
	<tr>
		...
		***************************
		--%>
		<td id="StandardBillMe_TableCell_1_<c:out value='${paramNumStatus}' />">
			<label for="StandardBillMe_OrderRemainingAmount_<c:out value='${paramNumStatus}' />"><fmt:message key="EDPPaymentMethods_PAYMENT_AMT_REMAINING" bundle="${edpText}"/></label>
		</td>
	</tr>
	<tr>
		<td id="StandardBillMe_TableCell_2_<c:out value='${paramNumStatus}' />">
			<input <c:if test="${remainingAmt lt 0.0}"> class="error" </c:if>
				class="input" type="text" name="remainingAmount" id="StandardBillMe_OrderRemainingAmount_<c:out value='${paramNumStatus}' />" readonly="readonly" value="<c:out value="${remainingAmt}"/>" />
		</td>
	</tr>
	</c:if>
	<tr>
		<td  valign="middle" id="StandardBillMe_TableCell_3_<c:out value='${paramNumStatus}' />">
			<label for="StandardBillMe_InputText_3_<c:out value='${paramNumStatus}' />">
	...
	<tr>
		<td  valign="middle" id="StandardBillMe_TableCell_4_<c:out value='${paramNumStatus}' />">
			<input class="input" type="text" name="piAmount" value="<c:out value="${edp_PayMethodAmount}" />" id="StandardBillMe_InputText_3_<c:out value='${paramNumStatus}' />" />
	...
	<tr>
		<td  valign="middle" id="StandardBillMe_TableCell_6_<c:out value='${paramNumStatus}' />">
			<c:import  url="${billingAddressSelectListPath}" >
				<c:param name="billingParmName" value="StandardBillMe_billing_address_id_${paramNumStatus}" />
...
<!-- End - JSP File Name: StandardBillMeLater.jsp -->
