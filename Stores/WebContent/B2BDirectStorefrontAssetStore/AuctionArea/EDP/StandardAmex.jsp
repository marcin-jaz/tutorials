...
<%-- 
  ...
  *    The file path of this snippet is Snippets/EDP/PaymentMethods/StandardAmex.jsp
...
<table cellpadding="3" cellspacing="0" border="0" id="StandardAmex_Table_1">
	<tr>
		<td colspan="4" valign="middle" id="StandardAmex_TableCell_11">
			<label for="StandardAmex_InputText_1"><span class="required">*</span><strong><fmt:message key="EDPPaymentMethods_AMEX_CARD_NUMBER" bundle="${edpText}"  /></strong></label>
	...
	<tr>
		<td colspan="4" valign="middle" id="StandardAmex_TableCell_21">
			<label for ="edp_Amex_cardExpiryMonth"><span class="required">*</span><strong><fmt:message key="EDPPaymentMethods_AMEX_EXPIRATION_MONTH" bundle="${edpText}"  /></strong></label>
		</td>
	...
	<tr>
		<td colspan="4" valign="middle" id="StandardAmex_TableCell_31">
			<label for="edp_Amex_cardExpiryYear"><span class="required">*</span><strong><fmt:message key="EDPPaymentMethods_AMEX_EXPIRATION_YEAR" bundle="${edpText}"  /></strong></label>
		</td>
...
function BuildPolicyString() {
	...
	ret = "policyId" + "=" + "<c:out value="${cardId}" />" + ";" + "cardBrand" + "=" + "<c:out value="${cardBrand}" />" + ";"+ "cc_brand" + "=" + "<c:out value="${cardBrand}" />" + ";" + "account" + "=" + cNumber + ";" + "expire_month" + "=" + cMonth + ";" + "expire_year" + "=" + cYear+";"+"billing_address_id"+"="+billing_address_id;//alert(ret);
	//alert(ret);
	return ret;
	}
