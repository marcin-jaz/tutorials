...
<c:set var="quantByLanguage" value="${requestScope.quantByLanguage}"  scope="request" />
...
<script language="javascript">
	...
	function submitAdd(form)
	{
		if (getValueFromSelection(form.<c:out value="${EC_ATTR_OPERATOR}" />) == '<c:out value="${EC_OPERATOR_ENUMERATION}" />') {
			...
			if (isValidInteger(getFront(form.value.value, ';')) == false)
			{
				error("<fmt:message key="RFQExtra_Error5" bundle="${storeText}" />");

				return;
			}
			if (isValidInteger(getEnd(form.value.value, ';')) == false)
			{
				error("<fmt:message key="RFQExtra_Error5" bundle="${storeText}" />");
				return;
			}			
			...
			if (isValidInteger(form.value.value) == false)
			{
				error("<fmt:message key="RFQExtra_Error5" bundle="${storeText}" />");
				return;
			}
...
<c:set var="value" value="${param.value}" scope="request" />
			...
			<input type="hidden" name="attrType" value="<c:out value="${EC_ATTRTYPE_STRING}" />" id="WC_RFQModifyAddSpecificationIntegerDisplay_FormInput_attrType_1"/>
			<input type="hidden" name="specJSP" value="RFQModifyAddSpecificationIntegerDisplay.jsp" id="WC_RFQModifyAddSpecificationIntegerDisplay_FormInput_specJSP_1"/>
			...
			<tr>
				<td height="21" id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_1">
					<label for="WC_RFQModifyAddSpecificationIntegerDisplay_Select_1"><fmt:message key="RFQModifyAddSpecificationDisplay_Op" bundle="${storeText}" /></label>					
				</td>
				<td id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_2">
 					<select id="WC_RFQModifyAddSpecificationIntegerDisplay_Select_1" class="select" name="<c:out value="${EC_ATTR_OPERATOR}" />">
 						<c:catch var="e">
			...
			<tr><td id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_3">&nbsp;</td></tr>
			<tr>
				<td height="21" id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_4">
					<span class="reqd">*</span>
					<label for="WC_RFQModifyAddSpecificationIntegerDisplay_FormInput_<c:out value="${EC_ATTR_VALUE}" />_1"><fmt:message key="RFQModifyAddSpecificationDisplay_Value" bundle="${storeText}" />					
				</label></td>
				<td id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_5">
					<input size="53" class="input" type="text" maxlength="128" name="<c:out value="${EC_ATTR_VALUE}" />" value="<c:out value="${value}" />" id="WC_RFQModifyAddSpecificationIntegerDisplay_FormInput_<c:out value="${EC_ATTR_VALUE}" />_1"/>
				</td>
			</tr>
			<tr>
				<td height="21" colspan="2" id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_6">
					<fmt:message key="RFQModifyAddSpecificationDisplay_MultiValue" bundle="${storeText}" />					
				</td>
			</tr>
			<tr><td id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_7">&nbsp;</td></tr>
			<tr>
				<td height="21" id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_8">
					<label for="WC_RFQModifyAddSpecificationIntegerDisplay_Select_2"><fmt:message key="RFQModifyAddSpecificationDisplay_Unit" bundle="${storeText}" />					
				</label></td>
				<td id="WC_RFQModifyAddSpecificationIntegerDisplay_TableCell_9">
					<select id="WC_RFQModifyAddSpecificationIntegerDisplay_Select_2" class="select" name="<c:out value="${EC_OFFERING_QTYUNIT}" />">
						<option value=""></option>	
