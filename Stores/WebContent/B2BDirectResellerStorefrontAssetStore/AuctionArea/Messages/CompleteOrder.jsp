...
<c:set var="orderId" value="${RequestProperties.orderId}"/>
...
<c:choose>
	...
	<fmt:message key="orderCompleteIntro" bundle="${storeText}" >
	...
	<fmt:message key="order.info" bundle="${storeText}" >
		<fmt:param value="${orderId}" />
	</fmt:message>
	-------------------------------------------------------------------    
	<fmt:message key="order.productTotal" bundle="${storeText}" >
		<fmt:param value="${orderProdTot}" />
	</fmt:message>
	<fmt:message key="order.productTax" bundle="${storeText}" >
		<fmt:param value="${orderTaxTot}" />
	</fmt:message>
	<fmt:message key="order.shipping" bundle="${storeText}" >
		<fmt:param value="${orderShChg}" />
	</fmt:message>
	<fmt:message key="order.shippingTax" bundle="${storeText}" >
		<fmt:param value="${orderShTax}" />
	</fmt:message>
	<fmt:message key="order.grandTotal" bundle="${storeText}" >
		<fmt:param value="${grandTotal}" />
	</fmt:message>
	<fmt:message key="order.dateTime" bundle="${storeText}" >
