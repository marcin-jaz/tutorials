...
<tr>
	<td id="WC_UserRegistrationAddForm_TableCell_19">
		<input type="password" class="logon input" maxlength="40" size="35" name="logonPassword" value="<c:out value="${WCParam.logonPassword}"/>" id="WC_UserRegistrationAddForm_FormInput_logonPassword_1"/>
	</td>
</tr>
<tr>
...
<tr>
	<td id="WC_UserRegistrationAddForm_TableCell_20">
		<input type="password" class="logon input" maxlength="40" size="35" name="logonPasswordVerify" value="<c:out value="${WCParam.logonPasswordVerify}"/>" id="WC_UserRegistrationAddForm_FormInput_logonPasswordVerify_1"/>
	</td>
</tr>
<tr>
