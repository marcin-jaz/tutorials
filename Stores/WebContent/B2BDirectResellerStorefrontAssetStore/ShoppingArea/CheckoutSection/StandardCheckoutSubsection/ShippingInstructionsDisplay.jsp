...
<!-- BEGIN AOPShippingInstructionsDisplay.jsp -->
<head>
...
<table cellpadding="0" cellspacing="0" border="0" class="p_width" id="WC_ShippingInstructionsDisplay_Table_1">
<tr>
<td id="WC_ShippingInstructionsDisplay_TableCell_1">
...
<form name="ShippingInstructionBlocksForm" action="ShipInfoUpdate" method="post" id="WC_ShippingInstructionsDisplay_Form_1">
	...
	<input type="hidden" name="langId" value="<c:out value="${langId}"/>" id="ShippingInstructionBlocksForm_FormInput_langId_In_ShopCartForm_1"/>
	<input type="hidden" name="storeId" value="<c:out value="${storeId}"/>" id="ShippingInstructionBlocksForm_FormInput_storeId_In_ShopCartForm_1"/>
	<input type="hidden" name="catalogId" value="<c:out value="${catalogId}"/>" id="ShippingInstructionBlocksForm_FormInput_catalogId_In_ShopCartForm_1"/>
	...
	<p>
		<a href="<c:out value="${ShippingMethodURL}"/>" class="button" id="WC_ShippingInstructionsDisplay_Link_1"><fmt:message key="Ship_Previous" bundle="${storeText}"/></a>
		<a href="javascript:submitForm(document.ShippingInstructionBlocksForm)" class="button" id="WC_ShippingInstructionsDisplay_Link_2"><fmt:message key="Ship_Next" bundle="${storeText}"/></a>
	</p>
</form>
...
<!-- END AOPShippingInstructionsDisplay.jsp -->
</html>
