...
<table class="gray" height="100%" width="300" id="WC_CachedHeadsUpDisplay_Table_1"><tr><td class="portlet" height="100%"  valign="top" id="WC_CachedHeadsUpDisplay_TableCell_1">
