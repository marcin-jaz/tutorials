...
--%>
<table cellpadding="0" cellspacing="0" border="0" width="100%" id="WC_ContentContainerTop_Table_1">
	<tr>
		<td class="greybackground" valign="top" id="WC_ContentContainerTop_TableCell_1">
			<table cellpadding="0" cellspacing="0" border="0" width="100%" id="WC_ContentContainerTop_Table_2">
				<tr>
					<td class="contentspc" valign="top" id="WC_ContentContainerTop_TableCell_2">
						<table cellpadding="0" cellspacing="0" border="0" class="content" id="WC_ContentContainerTop_Table_3">
							<tr>
								<td class="content2" valign="top" id="WC_ContentContainerTop_TableCell_3">
									<c:if test="${!empty param.frameTitle}">
										<table cellpadding="4" cellspacing="0" border="0" width="100%" id="WC_ContentContainerTop_Table_4">
											<tr>
												<td class="portlet_content" id="WC_ContentContainerTop_TableCell_4">
