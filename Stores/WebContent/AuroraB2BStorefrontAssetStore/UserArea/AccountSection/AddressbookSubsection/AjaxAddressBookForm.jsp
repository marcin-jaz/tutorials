	...
	<div class="my_account" id="WC_AjaxAddressBookForm_div_1">
		...
		<div dojoType="wc.widget.RefreshArea" widgetId="addressId" objectId="addressId" controllerId="addressBookController" class="body" id="addressIdRefreshArea" ariaMessage="<fmt:message bundle="${storeText}" key="ACCE_Status_Address_Book_Updated"/>" ariaLiveId="${ariaMessageNode}" role="region" aria-labelledby="addressIdRefreshArea_ACCE_Label">
			...
			<jsp:include page="../AddressbookSubsection/AccountForm.jsp" flush="true">
				<jsp:param name="addressId" value="${final.addressId}" />
				<jsp:param name="nickName" value="${final.nickName}" />
				<jsp:param name="firstName" value="${final.firstName}"/>
				<jsp:param name="lastName" value="${final.lastName}"/>
				<jsp:param name="middleName" value="${final.middleName}"/>
				<jsp:param name="address1" value="${final.addressLine[0]}"/>
				<jsp:param name="address2" value="${final.addressLine[1]}"/>
				<jsp:param name="city" value="${final.city}"/>
				<jsp:param name="state" value="${final.state}"/>
				<jsp:param name="countryReg" value="${final.country}"/>
				<jsp:param name="zipCode" value="${final.zipCode}"/>
				<jsp:param name="phone" value="${final.phone1}"/>
				<jsp:param name="email1" value="${final.email1}"/>
				<jsp:param name="addressType" value="${final.addressType}"/>
			</jsp:include>
		</div>
