...
<c:set var="pdcId" value="${productId}" scope="request"/>
...
<wcf:rest var="getPageDesignResponse" url="store/{storeId}/page_design">
	...
	<wcf:param name="pageGroup" value="PredDynaKit"/>
</wcf:rest>
...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		...
		<meta name="pageName" content="PredDynaKitPage"/>
...
<div id="entitledItem_<c:out value='${catalogEntryID}'/>" style="display:none;">
		...
		<div id="page">
			...
			<wcpgl:widgetImport uniqueID="${rootWidget.widgetDefinitionId}" debug="true"/>
