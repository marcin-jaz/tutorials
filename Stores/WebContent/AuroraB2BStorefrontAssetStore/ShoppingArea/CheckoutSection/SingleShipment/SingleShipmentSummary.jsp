												...
												<div class="shipping_address_summary" id="WC_SingleShipmentSummary_div_14">
													...
													<div id = "SingleShipmentShippingAddress" class="shipping_address_content">
														...
														<c:if test="${!empty contact.nickName}">
															...
															<c:otherwise>${contact.nickName}</c:otherwise></c:choose></p>
														</c:if>
													...
													<flow:ifEnabled feature="ShowHideOrderItems">
														...
														<div class="orderExpandArea">
															...
															<div dojoType="wc.widget.RefreshArea" widgetId="OrderItemPagingDisplay" id="OrderItemPagingDisplay" controllerId="OrderItemPaginationDisplayController" ariaMessage="<fmt:message bundle="${storeText}" key="ACCE_Status_Order_Item_List_Updated"/>" ariaLiveId="${ariaMessageNode}" role="region" aria-labelledby="OrderItemPagingDisplay_ACCE_Label" style="display:none;">
													...
													<flow:ifDisabled feature="ShowHideOrderItems">
														<script type="text/javascript">
															dojo.addOnLoad(function() {
																dojo.byId("OrderItemPagingDisplay").style.display="";
