												...
												<div class="body left" id="WC_SingleShipmentDisplay_div_16">
													<div id="shipping">
														...
														<flow:ifEnabled feature="ShowHideOrderItems">
															...
															<div class="orderExpandArea">  
																<span id="OrderItemsExpandArea">
																	<a id="OrderItemDetails_plusImage_link" class="tlignore" href="javaScript:CheckoutHelperJS.toggleOrderItemDetailsShipping('WC_SingleShipmentDisplay_div_17', 'traditionalShipmentDetailsContext', 'true');" onclick="javaScript:TealeafWCJS.processDOMEvent(event);">
																	...
																	<a id="OrderItemDetails_minusImage_link" style="display:none" class="tlignore" href="javaScript:CheckoutHelperJS.toggleOrderItemDetailsShipping('WC_SingleShipmentDisplay_div_17', 'traditionalShipmentDetailsContext', 'true');" onclick="javaScript:TealeafWCJS.processDOMEvent(event);">
																...
																<div dojoType="wc.widget.RefreshArea" widgetId="singleShipmentOrderDetails" controllerId="traditionalShipmentDetailsController" ariaMessage="<fmt:message bundle="${storeText}" key="ACCE_Status_Order_Item_List_Updated"/>" ariaLiveId="${ariaMessageNode}" role="region" id="WC_SingleShipmentDisplay_div_17" aria-labelledby="singleShipmentOrderDetails_ACCE_Label" style="display:none;">
																	<flow:ifEnabled feature="ShowHideOrderItems">
														...
														<flow:ifDisabled feature="ShowHideOrderItems">
															<script>
																dojo.addOnLoad(function() { 
																	dojo.byId("WC_SingleShipmentDisplay_div_17").style.display="";
																	parseWidget("WC_SingleShipmentDisplay_div_17"); 
																});
															</script>
														</flow:ifDisabled>
