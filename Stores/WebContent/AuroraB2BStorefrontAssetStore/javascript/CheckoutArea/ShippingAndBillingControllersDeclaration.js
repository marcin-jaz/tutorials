...
wc.render.declareRefreshController({
	...
	,modelChangedHandler: function(message, widget) {
		...
		if(SBControllersDeclarationJS.isAjaxCheckOut()){
			if (message.actionId == "AddBillingAddressInCheckOut" || message.actionId == "UpdateBillingAddressInCheckout" || message.actionId == "AjaxUpdateAddressForPerson" || message.actionId == "AjaxAddShippingAndBillingAddressForPersonDuringCheckout"){
