...
<%--
  * This eMarketingSpotDisplay.jsp file is built as a sample snippet to display an e-Marketing Spot in an
  * email. It uses Web services to call the Dialog Marketing runtime to get the data to display
...
%>   
  ...
  <c:forEach var="marketingSpotData" items="${marketingSpotDatas.baseMarketingSpotActivityData}">
		<c:if test='${marketingSpotData.dataType eq "Jsp"}'>
         <html>
	          <head>
		          <meta http-equiv="Refresh" content="0;URL=<c:out value="${marketingSpotData.uniqueID}"/>"/>
	          </head>
