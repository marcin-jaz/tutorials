...
//-----------------------------------------------------------------
	...
	CatalogSearchDisplayJS={	
		...
		* @param {string} searchType This is the type of the search simple/advanced.
		*/			
		submitAdvancedSearch:function(formId, searchType){
			...
			this.showHideSearchMode(false,searchType);
		...
		*/
		setResultSummaryMessage:function(){
			...
			if(dojo.byId("cancelSearchButton")!=null && dojo.byId("cancelSearchButton")!='undefined'){
