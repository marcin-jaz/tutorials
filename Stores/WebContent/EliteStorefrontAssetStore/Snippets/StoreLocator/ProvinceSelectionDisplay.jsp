...
<select name="selectState" id="selectState" class="drop_down" onchange="JavaScript:storeLocatorJS.changeProvinceSelection(this.options[this.selectedIndex].value);">
