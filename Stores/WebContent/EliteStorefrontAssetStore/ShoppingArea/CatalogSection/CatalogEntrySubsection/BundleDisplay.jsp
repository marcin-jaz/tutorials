...
<head>
<title><fmt:message key="PRODUCT_TITLE" bundle="${storeText}" />: <c:out value="${bundle.description.name}" escapeXml="false"/></title>
<meta name="description" content="<c:out value="${bundle.description.longDescription}"/>"/>
<meta name="keyword" content="<c:out value="${bundle.description.name}"/>"/>
