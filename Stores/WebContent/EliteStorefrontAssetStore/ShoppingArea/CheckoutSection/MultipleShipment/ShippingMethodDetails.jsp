...
<div class="shipping_method_MS_shipping_info_page" id="WC_ShippingMethodDetails_div_1">
	<p>
		<label for="MS_ShippingMode_<c:out value='${orderItemId}'/>"></label>
		<select class="drop_down" name="MS_ShippingMode_<c:out value='${orderItemId}'/>" id="MS_ShippingMode_<c:out value='${orderItemId}'/>" onchange="JavaScript:setCurrentId('MS_ShippingMode_<c:out value='${orderItemId}'/>'); CheckoutHelperJS.updateShipModeForThisItem(this,'<c:out value="${orderItemId}"/>')">
			<c:forEach var="shippingMode" items="${usableShippingMode}">
				...
				<c:if test="${shippingModeIdentifier.externalIdentifier.shipModeCode != 'PickupInStore'}">
					...
					<option <c:if test="${(shippingModeIdentifier.uniqueID eq selectedShipModeId)}">selected="selected"</c:if> value="<c:out value='${shippingModeIdentifier.uniqueID}'/>">
	...
	<c:if test="${!isFreeGift}">
		<flow:ifEnabled feature="ShippingInstructions">
			...
			<p>
				<span class="checkbox">
					...
					<input type="checkbox" class="checkbox" id="MS_shippingInstructionsCheckbox_<c:out value='${orderItemId}'/>" name="MS_shippingInstructionsCheckbox_<c:out value='${orderItemId}'/>" onclick="JavaScript:setCurrentId('MS_shippingInstructionsCheckbox_<c:out value='${orderItemId}'/>');CheckoutHelperJS.checkShippingInstructionsBox('MS_shippingInstructionsCheckbox','MS_shippingInstructionsDiv','<c:out value='${orderItemId}'/>')"
			...
			<div name = "MS_shippingInstructionsDiv_<c:out value='${orderItemId}'/>" id = "MS_shippingInstructionsDiv_<c:out value='${orderItemId}'/>" style="display:<c:out value='${shippingInstructionsDivDisplay}'/>">
				<span>
					...
					<p>
						<textarea id="MS_shipInstructions_<c:out value='${orderItemId}'/>" name="MS_shipInstructions_<c:out value='${orderItemId}'/>" rows="2" onchange="JavaScript:setCurrentId('MS_shipInstructions_<c:out value='${orderItemId}'/>');CheckoutHelperJS.updateShippingInstructionsForThisItem(this,'<c:out value='${orderItemId}'/>')"><c:out value = "${shipInstructions}" /></textarea>
					</p>
				</span>
			</div>
		</flow:ifEnabled>
		...
		<flow:ifEnabled feature="FutureOrders">
			...
			<p>
				<span class="checkbox">
					...
					<input type="checkbox" class="checkbox" id="MS_requestShippingDateCheckbox_<c:out value='${orderItemId}'/>" name="MS_requestShippingDateCheckbox_<c:out value='${orderItemId}'/>" onclick="JavaScript:setCurrentId('MS_requestShippingDateCheckbox_<c:out value='${orderItemId}'/>');CheckoutHelperJS.checkRequestShippingDateBox('MS_requestShippingDateCheckbox','MS_requestShippingDateDiv','<c:out value='${orderItemId}'/>')"
			...
			<div name="MS_requestShippingDateDiv_<c:out value='${orderItemId}'/>" id="MS_requestShippingDateDiv_<c:out value='${orderItemId}'/>" style="display:<c:out value='${requestShippingDateDivDisplay}'/>">
				...
				<div id="MS_requestedShippingDate_<c:out value='${orderItemId}'/>_inputField" class="dijitCalendarWidth">
					<input 
						...
						size="6" 
						onChange="JavaScript:setCurrentId('MS_requestedShippingDate_<c:out value='${orderItemId}'/>');CheckoutHelperJS.updateRequestedShipDateForThisItem(this, '<c:out value='${orderItemId}'/>'); <c:if test="${!isAjaxCheckOut}">setDirtyFlag()</c:if>" 
		...
		<flow:ifEnabled feature="ExpeditedOrders">
			<span class="checkbox">
				<input type="checkbox" class="checkbox" id="MS_expediteShipping_<c:out value='${orderItemId}'/>" name="MS_expediteShipping_<c:out value='${orderItemId}'/>" onclick="JavaScript: setCurrentId('MS_expediteShipping_<c:out value='${orderItemId}'/>'); CheckoutHelperJS.expediteShipping(this, <c:out value='${orderItemId}'/>);"
