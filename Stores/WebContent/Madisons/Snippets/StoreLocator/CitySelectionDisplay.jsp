...
<select name="selectCity" id="selectCity" class="drop_down" onchange="Javascript:JavaScript:storeLocatorJS.changeCitySelection(this.options[this.selectedIndex].value);">
