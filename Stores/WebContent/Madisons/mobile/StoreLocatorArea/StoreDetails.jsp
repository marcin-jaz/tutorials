...
<%--
  *****
  * This JSP displays the store detail page.
  *****
--%>

<!-- BEGIN StoreDetails.jsp -->
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${shortLocale}" xml:lang="${shortLocale}">
	...
	<head>
		...
		<title>
			<fmt:message key="MSTDT_TITLE" bundle="${storeText}">
	...
	<body>
		...
		<div id="wrapper">
			...
			<c:import url="${jspStoreDir}mobile/Snippets/StoreLocator/StoreInfo.jsp">
				...
				<c:param name="infoType" value="Details" />
