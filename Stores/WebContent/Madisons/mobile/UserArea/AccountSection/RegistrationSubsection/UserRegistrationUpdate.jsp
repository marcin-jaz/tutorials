...
<c:choose>
	<c:when test="${userType == 'G'}">
		<c:set var="incfile" value="${jspStoreDir}mobile/UserArea/AccountSection/LogonSubsection/logon.jsp"/>
	</c:when>
	<c:otherwise>
		<c:set var="incfile" value="${jspStoreDir}mobile/UserArea/AccountSection/RegistrationSubsection/UserRegistrationUpdateForm.jsp"/>
	</c:otherwise>
</c:choose>
