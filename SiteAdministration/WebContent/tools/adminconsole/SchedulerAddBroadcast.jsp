...
<!---- //hide script from old browsers
    ...
    function validatePanelData() {
          ...
          // building the URL
          <%= (jobId != null && !jobId.equals("")) ? "var url = 'EditJob?URL=MsgMessagingSystemResponseView&ERR_COM=MsgMessagingSystemResponseView&jobId="+UIUtil.toJavaScript(jobId)+"';" : "var url = 'AddBroadcastJob?URL=MsgMessagingSystemResponseView&ERR_COM=MsgMessagingSystemResponseView';" %>
          var params = '';
          var pathInfo = '';
          var start = '';
