...
<!---- //hide script from old browsers
    ...
    function validatePanelData() {
          ...
          // building the URL
          <%= (jobId != null && !jobId.equals("")) ? "var url = 'EditJob?URL=MsgMessagingSystemResponseView&ERR_COM=MsgMessagingSystemResponseView&jobId="+UIUtil.toJavaScript(jobId)+"';" : "var url = 'AddJob?URL=MsgMessagingSystemResponseView&ERR_COM=MsgMessagingSystemResponseView';" %>
          var params = '';
          var pathInfo = '';
          var start = '';
...
%>
     ...
     <TD><INPUT NAME="startTime" VALUE="<%= UIUtil.toHTML(startTime) %>" maxlength="5" size="5" id="S3"></TD></TR>     
     </TABLE></TD></TR>
