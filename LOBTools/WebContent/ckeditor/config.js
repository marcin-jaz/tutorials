...
CKEDITOR.editorConfig = function( config ) {
	...
	var spellCheckLanguage = 'en';
	if (typeof contentLocale != 'undefined') {
		spellCheckLanguage = contentLocale;
	}
	config.extraPlugins += ',ibmspellchecker';
	config.ibmSpellChecker = {
		service:'XTAF',
		restUrl: '/lobtools/cmc/CKEditorSpellCheckService',
