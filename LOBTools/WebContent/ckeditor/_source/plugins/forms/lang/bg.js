...
CKEDITOR.plugins.setLang( 'forms', 'bg', {
	...
	checkboxAndRadio: {
		checkboxTitle : "Свойства на полето за избор",
		radioTitle	: "Свойства на бутона за радио",
		value		: "Стойност:",
		selected	: "Избрано"
	},	
	form: {
	...
	select: {
		...
		size		: "Размер:",
		lines		: "линии",
		chkMulti	: "Позволяване на множество селекции",
		opText		: "Текст:",
		opValue		: "Стойност:",
		btnAdd		: "Добавяне",
		btnModify	: "Промяна",
	...
	textarea: {
		title		: "Свойства на зоната за текст",
		cols		: "Колони:",
		rows		: "Редове:"
	},
	textfield: {
		title		: "Свойства на полето за текст",
		name		: "Име:",
		value		: "Стойност:",
		charWidth	: "Ширина на символ:",
		maxChars	: "Максимален брой символи:",
		type		: "Тип:",
		typeText	: "Текст",
		typePass 	: "Парола",
		typeEmail	: "Имейл",
