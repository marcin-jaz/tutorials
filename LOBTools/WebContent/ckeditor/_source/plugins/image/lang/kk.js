...
*/
CKEDITOR.plugins.setLang( 'image', 'kk', {
	alertUrl	: "Сурет URL мекен-жайын жазыңыз",
	alt		: "Балама мәтін:",
	border	: "Жиек:",
	btnUpload	: "Кескінді жүктеп салу",
	button2Img	: "Таңдалған сурет түймешігін қарапайым суретке айналдыру керек пе?",
	hSpace	: "Көлденең орын:",
	img2Button	: "Таңдалған суретті сурет түймешігіне айналдыру керек пе?",
	...
	upload	: "Жүктеп салу",
	urlMissing : "Сурет көзінің URL мекен-жайы жоқ.",
	vSpace	: "Тік орын:",
