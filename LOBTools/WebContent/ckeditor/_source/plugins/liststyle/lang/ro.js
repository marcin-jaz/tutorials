...
CKEDITOR.plugins.setLang( 'liststyle', 'ro', {
	...
	circle				: "Cerc",
	decimal				: "Zecimal (1, 2, 3, etc.)",
	decimalLeadingZero	: "Zecimal cu zero la început (01, 02, 03, etc.)",
	disc				: "Disc",
	georgian			: "Numerotare georgiană (an, ban, gan, etc.)",
	lowerAlpha			: "Alfa mici (a, b, c, d, e, etc.)",
	lowerGreek			: "Greacă mică (alpha, beta, gamma, etc.)",
	...
	start				: "Pornire:",
	type				: "Stil listă:",
	upperAlpha			: "Alfa mari (A, B, C, D, E, etc.)",
