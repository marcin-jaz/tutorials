			...
			[
				{
					...
					legend: 
						"Siirry työkaluriville painamalla näppäintä ${toolbarFocus}. " +
...

				{
					...
					legend :
						...
						"Siirry edelliseen välilehteen painamalla näppäinyhdistelmää VAIHTO+SARKAIN tai painamalla VASENTA NUOLINÄPPÄINTÄ. " +
						"Valitse välilehtisivu painamalla VÄLILYÖNTIÄ tai ENTER-näppäintä."
				},
