		...
		},
		{
			...
			[
				...
				},
				{
					...
					legend: 'Tryck på ${accessPreviousSpace} om du vill infoga ett blanksteg omedelbart före markören i ett fokusområde som det inte går att gå till. ' +
				...
				},
				{
					...
					legend: 'Tryck på ${accessNextSpace} om du vill infoga ett blanksteg omedelbart efter markören i ett fokusområde som det inte går att gå till. ' +
						'Ett fokusområde som det inte går att gå till är en plats där du inte kan placera markören ' +
						'med hjälp av musen eller tangentbordet. Du kan till exempel använda det här kommandot till att infoga innehåll mellan två intilliggande tabellelement.'
				},
				{
