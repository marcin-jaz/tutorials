...
CKEDITOR.plugins.setLang( 'specialchar', 'ru',
{
	...
	not: "Знак отрицания",
	reg: "Знак регистрации",
	macr: "Макрон",
	deg: "Символ градусов",
	sup2: "Второй верхний индекс",
	sup3: "Третий верхний индекс",
	acute: "Знак акут",
	micro: "Знак микро",
	para: "Знак абзаца",
	middot: "Точка посредине",
	cedil: "Седиль",
	sup1: "Первый верхний индекс",
	...
	iquest: "Инвертированный вопросительный знак",
	...
	Aring: "Латинская прописная буква A с кольцом сверху",
	...
	Oslash: "Латинская прописная буква O с ударением",
	...
	aring: "Латинская строчная буква a с кольцом сверху",
	...
	divide: "Знак деления",
	oslash: "Латинская строчная буква o с ударением",
