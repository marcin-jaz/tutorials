...
CKEDITOR.plugins.setLang( 'ibmtabletools', 'kk', {
	...
	sortTable : "Кестені сұрыптау",
	colNumber : "Баған",
	sortOrderAsc : "Артуы бойынша",
	sortOrderDesc : "Кемуі бойынша",
	sortOrder : "Сұрыптау реті",
	alphanumericType : "Әріптер және сандық",
	numericType : "Сандық",
	sortType : "Сұрыптау түрі",
	invalidColumnNumber	: "Баған саны оң сан болуы керек.",
	noColumnNumber	: "Баған саны жоқ."
});
