...
CKEDITOR.plugins.setLang( 'ibmtabletools', 'iw', {
	...
	sortTable : "מיון טבלה ",
	colNumber : "עמודה",
	sortOrderAsc : "סדר עולה",
	sortOrderDesc : "סדר יורד",
	sortOrder : "סדר מיון",
	alphanumericType : "אלפאנומרי",
	numericType : "נומרי",
	sortType : "סוג מיון ",
	invalidColumnNumber	: "מספר העמודה חייב להיות מספר חיובי.",
	noColumnNumber	: "מספר העמודה חסר."
});
