...
CKEDITOR.plugins.setLang( 'ibmtabletools', 'pt-br', {
	...
	invalidColumnWidth	: "Largura da coluna deve ser um número positivo.",
	...
	invalidColumnNumber	: "Número da coluna deve ser positivo.",
	noColumnNumber	: "Número da coluna ausente."
});
