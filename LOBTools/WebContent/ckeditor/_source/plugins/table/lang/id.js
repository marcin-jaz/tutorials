...
CKEDITOR.plugins.setLang( 'table', 'id', {
	...
	cell: {
		...
		yes				: "Ya",
		no				: "Tidak",
		invalidWidth	: "Lebar sel harus berupa angka positif.",
		invalidHeight	: "Tinggi sel harus berupa angka positif.",
		...
		chooseColor 	: "Lebih Banyak Warna...",
		ibm :
		{
			title : "Sel"
		}
	...
	invalidBorder	: "Ukuran tepian harus berupa angka positif.",
	invalidCellPadding	: "Pengisi sel harus berupa angka positif.",
	invalidCellSpacing	: "Jarak antar sel harus berupa angka positif.",
	invalidCols		: "Jumlah kolom harus berupa bilangan bulat lebih besar dari nol.",
	invalidHeight	: "Tinggi tabel harus berupa angka positif.",
	invalidRows		: "Jumlah baris harus berupa bilangan bulat lebih besar dari nol.",
	invalidWidth	: "Lebar tabel harus berupa angka positif.",
	menu		: "Properti Tabel",
	row: {
		menu			: "Baris",
	...
	ibm :
	{
		createTable : 'Sisipkan Tabel',
		heightUnit	: "Unit tinggi:",		
		fixedColWidths : "Lebar kolom tetap"
	}
});	
