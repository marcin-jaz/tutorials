...
*/
CKEDITOR.plugins.setLang( 'link', 'kk', {

	acccessKey		: "Рұқсат кілті:",
	advanced	: "Жетілдірілген",		
	advisoryContentType	: "Кеңес мазмұнының Түр:",			
	...
	name			: "Аты:",
	noAnchors		: "Құжатта қол жетімді бетбелгілер жоқ. Құралдар тақтасында 'Құжат бетбелгісін қою' белгішесін жаңасын қосу үшін басыңыз.",
	noEmail			: "Электрондық пошта мекен-жайын жазыңыз",
	noUrl			: "Сілтеме URL мекен-жайын жазыңыз",
	other 		: "басқа",
	...
	toUrl		: "URL",
	toolbar		: "URL мекен-жайы сілтемесі",
	type		: "Сілтеме Түр:",
