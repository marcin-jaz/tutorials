...
CKEDITOR.plugins.setLang( 'link', 'el', {
	...
	noEmail			: "Πληκτρολογήστε τη διεύθυνση e-mail",
	noUrl			: "Πληκτρολογήστε τη διεύθυνση URL της διασύνδεσης",
	other 		: "άλλο",
	...
	title		: "Διασύνδεση",
	toAnchor	: "Διασύνδεση με αγκύρωση στο κείμενο",
	toEmail		: "Διεύθυνση e-mail",
	toUrl		: "Διεύθυνση URL",
	toolbar		: "Διασύνδεση διεύθυνσης URL",
